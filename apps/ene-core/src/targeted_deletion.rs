...
mod tests {
    ...
    use ene_preservation::{
        ...
        ErasureParticipant, MechanicalDeletionTarget, ParticipantCompletionFact,
        ParticipantCompletionStatus, ParticipantHoldClass, ParticipantOwnerRef,
    ...
    async fn a_multi_page_erasure_survives_a_host_restart() {
        ...
        let DeletionMaterialOutcome::Material(material) = handle
            ...
            panic!("the unfinished operation keeps its material");
        };
        assert!(
