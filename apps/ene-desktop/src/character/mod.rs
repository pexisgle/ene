...
mod camera_target_tests {
    ...
    fn model_with_chest_chain(
        ...
        let nodes = NodeHierarchy {
            ...
            rest_world_rotations: vec![Quat::IDENTITY; n],
            rest_world_positions: vec![Vec3::ZERO; n],
        };
    ...
    fn chest_world_rest_y_sums_only_y_axis() {
        ...
        let nodes = NodeHierarchy {
            ...
            rest_world_rotations: vec![Quat::IDENTITY; 2],
            rest_world_positions: vec![Vec3::ZERO; 2],
        };
