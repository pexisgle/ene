...
use ene_cognition::character::{
    CharacterProcessor, LorebookIndexer, StyleExampleSelector, sync_character_memories,
};
use ene_cognition::config::CharacterMemoryConfig;
use ene_cognition::recall::merge_lorebook_recall;
use ene_config::{CharacterCardV3, Lorebook, LorebookEntry};
use ene_memory::MemoryStore;
use ene_provider::{EmbeddingKind, EmbeddingProvider};
