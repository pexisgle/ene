...
mod tests {
    ...
    type StreamResult = std::pin::Pin<
        Box<
            dyn tokio_stream::Stream<
                    Item = Result<ene_provider::LlmResponseChunk, ene_provider::LlmProviderError>,
                > + Send,
        >,
    >;
    ...
    impl ene_provider::LlmProvider for MockProvider {
        fn name(&self) -> &str {
            "mock"
        }
        ...
        ) -> Result<StreamResult, ene_provider::LlmProviderError> {
            Err(ene_provider::LlmProviderError::Provider(
    ...
    #[async_trait::async_trait]
    impl ene_provider::LlmProvider for TimeoutProvider {
        fn name(&self) -> &str {
            "timeout-mock"
        }
    ...
    #[async_trait::async_trait]
    impl ene_provider::LlmProvider for GarbageProvider {
        fn name(&self) -> &str {
            "garbage-mock"
        }
