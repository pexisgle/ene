...
impl TaskRepository for FakeTaskRepository {
    ...
    async fn load_task(
        ...
        Err(fixture::unsupported("load_task"))
    }
    ...
    async fn load_delegation(
        ...
        Err(fixture::unsupported("load_delegation"))
    }
    ...
    async fn load_delegation_result(
        ...
        Err(fixture::unsupported("load_delegation_result"))
    }
    ...
    async fn delegation_has_started_work(
        ...
        Err(fixture::unsupported("delegation_has_started_work"))
    }
    ...
    async fn adopt_result(
        ...
        self.acceptance
            ...
            .clone()
            .ok_or_else(|| fixture::unsupported("adopt_result"))
    }
