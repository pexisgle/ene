...
impl ConversationTaskRepository for GuardedResumeRepository {
    ...
    ) -> Result<ene_task::TaskCreationOutcome, TaskTechnicalError> {
        Err(TaskTechnicalError::StorageUnavailable {
            reason: String::from("creation is outside this fixture's scope"),
        })
    }
    ...
    async fn forward_steering_from_conversation(
        ...
        Err(TaskTechnicalError::StorageUnavailable {
            reason: String::from("steering is outside this fixture's scope"),
        })
    }
    ...
    async fn cancel_task_from_conversation(
        ...
        Err(TaskTechnicalError::StorageUnavailable {
            reason: String::from("cancel is outside this fixture's scope"),
        })
    }
