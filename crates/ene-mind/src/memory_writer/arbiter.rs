...
mod tests {
    ...
    #[test]
    fn repeated_tool_failure_supersedes_prior_record() {
        let tools = [ToolResultSummary {
            tool_name: "web".to_string(),
            success: false,
    ...
    #[test]
    fn tool_derived_candidate_with_unknown_tool_is_rejected() {
        let tools = [ToolResultSummary {
            tool_name: "fs".to_string(),
            success: false,
    ...
    #[test]
    fn tool_derived_candidate_with_boilerplate_only_content_is_rejected() {
        let tools = [ToolResultSummary {
            tool_name: "web".to_string(),
            success: false,
            summary: "error: timeout".to_string(),
