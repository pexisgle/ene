...
//!
//! Tracks consecutive call failures for a single plugin. After a configurable
...
//! repeatedly hammering a broken plugin. A successful call closes the breaker
...
impl CircuitBreaker {
    ...
    /// cascade of calls to a still-broken plugin.
