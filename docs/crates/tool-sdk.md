...
> **Crates**: `ene-plugin-db` | `ene-tool-macros`

Helper library crates supporting tool-plugin authoring: stateful storage
access for tool binaries and proc-macro derives for tool boilerplate.
