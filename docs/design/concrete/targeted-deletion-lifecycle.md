...
- body-bearing read（History item、presentation excerpt、report source、management view の Memory 本文 / revision 履歴 / grounds）は、本文を実際に返した時点を delivery 証拠として Host-memory に記録し、covered 本文は同じ read 時に withhold します。
