...
新しい semantic owner、第二の正本、万能Security Pipeline / Execution Manager / Policy Engine / Inference Service、統一Permission state machine、共通Context layerを追加しない。Subsystem と crate / process / service を一対一に対応させない。Host側とClient側に同名Subsystemを複製しない。
