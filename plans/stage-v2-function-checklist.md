...
- [ ] `OverlayFocus::mark_pending_loss` (private, L131)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayFocus::expire_pending_loss` (private, L143)
  - 役割: Drop protection once a pending focus loss outlives its grace period. Returns whether the state changed and a sync is required.
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayFocus::clear` (private, L154)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: retarget_clears_session_scoped_questions_and_approvals
  - 結果:

- [ ] `OverlayFocus::clear_target` (private, L161)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayFocus::cancel_pending_loss` (private, L169)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayFocus::protects` (private, L174)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:
...
- [ ] `StageApp::chrome_window_exists` (private, L458)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::global_cursor_to_physical` (private, L468)
...
- [ ] `StageApp::sync_overlay_interaction` (private, L477)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::open_chat` (private, L562)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::spawn` (private, L593)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::request_active_soul` (private, L607)
...
- [ ] `StageApp::claim_speaker_notify` (private, L618)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::drain_async_results` (private, L645)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::apply_async_outcome` (private, L656)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::apply_listed_approvals` (private, L1461)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::set_pending_approval` (private, L1484)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::poll_pending_approvals` (private, L1513)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::request_memories` (private, L1533)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::request_characters` (private, L1572)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::request_jobs` (private, L1585)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::request_history_refresh` (private, L1600)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::begin_completion_reconciliation` (private, L1621)
...
- [ ] `StageApp::schedule_completion_refresh` (private, L1638)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::start_new_session` (private, L1657)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::toggle_mic` (private, L1675)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::sync_stt_cta_after_settings_parse` (private, L1707)
...
- [ ] `StageApp::send_chat` (private, L1713)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: send_chat_paints_the_optimistic_user_row_immediately
  - 結果:

- [ ] `StageApp::push_optimistic_user_row` (private, L1761)
...
- [ ] `StageApp::complete_optimistic_user_row` (private, L1767)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::discard_optimistic_user_row` (private, L1785)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::append_optimistic_user_row` (private, L1795)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::handle_avatar_reaction` (private, L1813)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::send_direct_reaction` (private, L1841)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::request_direct_reaction_retarget` (private, L1854)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::select_greeting` (private, L1866)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::answer_question` (private, L1885)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::barge_in` (private, L1910)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::cancel_turn` (private, L1929)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::respond_approval` (private, L1948)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::save_local_settings` (private, L1976)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::save_local_settings_with_status` (private, L1980)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::overlay_monitor_target` (private, L2012)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::record_overlay_monitor` (private, L2051)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::clamp_overlay_positions` (private, L2072)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::apply_overlay_monitor` (private, L2107)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::refresh_monitor_inventory` (private, L2163)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::process_overlay_monitor_action` (private, L2177)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::sync_chrome_titles` (private, L2186)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::toggle_overlay_chrome` (private, L2201)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::raise_chrome` (private, L2216)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::dispatch_shell_command` (private, L2230)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::poll_shell` (private, L2245)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::process_surface_actions` (private, L2278)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::drain_surface_events` (private, L2307)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::seed_history_from_session` (private, L2317)
...
- [ ] `StageApp::persist_body_position` (private, L2327)
...
- [ ] `StageApp::has_avatar_occupant` (private, L2341)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::visible_display_count` (private, L2347)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::include_soul_in_display` (private, L2358)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::apply_display_action` (private, L2381)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::request_detail_and_overlay_redraw` (private, L2468)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::apply_live_event` (private, L2480)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::drain_detail_events` (private, L2597)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::spawn_listen` (private, L2641)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::poll_audio` (private, L2655)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::reload_avatar` (private, L2676)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::cycle_occupant` (private, L2780)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::active_companion_label` (private, L2794)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::chat_targets` (private, L2798)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::companion_label_for_soul` (private, L2810)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::overlay_motion_controls` (private, L2818)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::apply_motion_command` (private, L2842)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::cycle_active_motion` (private, L2880)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::select_occupant` (private, L2902)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::commit_session_target` (private, L2941)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::open_detail` (private, L2963)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::drop_focus_if_no_chrome` (private, L2994)
  - 役割: Clear focus protection only when no other chrome window can hold it.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::sync_caption_window` (private, L3000)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::ensure_caption` (private, L3006)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::ensure_spotlight` (private, L3028)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::handle_overlay_key` (private, L3047)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::handle_overlay_shortcut` (private, L3063)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::abort_audio_playback` (private, L3081)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::apply_expression_cue` (private, L3092)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::camera_basis` (private, L3106)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::overlay_hit_candidates` (private, L3119)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::on_overlay_cursor_moved` (private, L3140)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::on_overlay_pointer_moved` (private, L3144)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::on_overlay_press` (private, L3178)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::on_overlay_pointer_press_with_protection` (private, L3182)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::on_overlay_pointer_press` (private, L3226)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::on_overlay_release` (private, L3269)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::on_overlay_pointer_release` (private, L3273)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::cancel_overlay_pointer` (private, L3295)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::tick_overlay` (private, L3302)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::sync_overlay_slint` (private, L3420)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::overlay_ui_request` (private, L3488)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::rebuild_scene` (private, L3499)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::paint_chrome` (private, L3602)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::sync_chat_slint` (private, L3686)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::drain_chat_actions` (private, L3746)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::sync_detail_slint` (private, L3788)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::drain_detail_actions` (private, L3845)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::read_detail_drafts` (private, L3902)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::dispatch_detail_primary` (private, L3942)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::submit_new_job` (private, L3992)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::cancel_job` (private, L4026)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: cancel_job_other_errors_stay_raw
  - 結果:

- [ ] `StageApp::reload_mcp_tools` (private, L4041)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::apply_body_ref` (private, L4054)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::import_character_dialog` (private, L4073)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::start_character_import` (private, L4083)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::sync_spotlight_slint` (private, L4106)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::drain_spotlight_actions` (private, L4128)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::close_chat_window` (private, L4156)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::close_detail_window` (private, L4162)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::close_caption_window` (private, L4168)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageApp::close_spotlight_window` (private, L4173)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `chat_send_block_reason` (private, L4180)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `chat_window_action` (private, L4299)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageApp::resumed` (private, L4308)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageApp::window_event` (private, L4393)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageApp::about_to_wait` (private, L4590)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `auth_failure` (private, L4624)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `provider_asset_load_status` (private, L4631)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: provider_asset_load_status_reports_success_and_empty_results
  - 結果:

- [ ] `window_level` (private, L4636)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: save_applies_window_level_for_transparent_and_opaque_overlays
  - 結果:

- [ ] `overlay_window_level` (private, L4645)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `window_focus_state` (private, L4654)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / true/false
  - 既存テスト: window_focus_state_ignores_non_focus_events
  - 結果:

- [ ] `should_repaint_after_event` (private, L4664)
...
- [ ] `apply_theme_overlay` (private, L4668)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `apply_theme_chat` (private, L4672)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `apply_theme_detail` (private, L4676)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `apply_theme_caption` (private, L4680)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `apply_theme_spotlight` (private, L4684)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `apply_ene_theme` (private, L4688)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `user_theme_file` (private, L4700)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `spotlight_entry_id` (private, L4704)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `format_log_text` (private, L4719)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `disambiguated_occupant_label` (private, L4728)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `map_turn_err` (private, L4752)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `project_world_to_px` (private, L4762)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `world_aabb_to_px` (private, L4786)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `position_changed` (private, L4828)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `direct_reaction_expression` (private, L4835)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `direct_reaction_message` (private, L4843)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `create_denied_by_approval` (private, L4858)
...
- [ ] `friendly_create_job_error` (private, L4865)
...
- [ ] `cancel_already_terminal` (private, L4876)
...
- [ ] `friendly_cancel_job_error` (private, L4882)
  - 役割: Replace the raw cancel 409 with a short status, keeping unrelated failures intact.
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `request_active_soul_enqueues_a_load_soul_outcome` (private, L6279)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: request_active_soul_enqueues_a_load_soul_outcome
  - 結果:

- [ ] `mic_toggle_is_blocked_until_stt_is_configured` (private, L6309)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
...
- [ ] `Resampler::new` (pub, L26)
  - 役割: コンストラクタ
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `Resampler::process` (pub, L34)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `AudioHub::new` (pub, L39)
  - 役割: コンストラクタ
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `AudioHub::new_with_mic_device` (pub, L44)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `AudioHub::set_mic_device` (pub, L63)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `AudioHub::list_input_device_names` (pub, L78)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `AudioHub::poll_mic_batches` (pub, L90)
  - 役割: Coalesced 16 kHz frames for the listen stream (~100 ms each).
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `AudioHub::play_pcm` (pub, L118)
  - 役割: Play mono/stereo-interleaved PCM at `sample_rate`.
  - 視点: 正常系 / エラー / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `AudioHub::stop` (pub, L131)
  - 役割: Stop playback and clear the viseme PCM buffer (no-op without `voice`).
  - 視点: 正常系
  - 既存テスト: stop_clears_recent_playback_pcm
  - 結果:

- [ ] `AudioHub::playback_pcm` (pub, L140)
  - 役割: Recent playback PCM for lip-sync analysis.
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: stop_clears_recent_playback_pcm
  - 結果:

- [ ] `AudioHub::sample_rate` (pub, L152)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `AudioHub::is_tts_playing` (pub, L165)
  - 役割: Whether local TTS playback is still queued (echo-aware barge-in).
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `AudioHub::mic_barge_in` (pub, L178)
  - 役割: Whether mic energy exceeded the barge-in threshold.
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `AudioHub::analyze_visemes` (pub, L190)
  - 役割: Analyze playback audio into viseme weights (no-op without `voice`).
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for AudioHub::default` (private, L209)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `MicCapture::new` (pub, L237)
  - 役割: コンストラクタ
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `MicCapture::new_with_device` (pub, L245)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `MicCapture::try_recv` (pub, L253)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `MicCapture::barge_in_active` (pub, L258)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::new` (pub, L271)
  - 役割: コンストラクタ
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::play_pcm` (pub, L275)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::stop` (pub, L279)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: stop_clears_recent_playback_pcm
  - 結果:

- [ ] `AudioPlayback::recent_pcm` (pub, L282)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::sample_rate` (pub, L287)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `Trait for AudioPlayback::default` (private, L27)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::new` (pub, L33)
  - 役割: コンストラクタ
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::tts_playing_flag` (pub, L63)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::play_pcm` (pub, L67)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::stop` (pub, L96)
  - 役割: Drop queued PCM and stop the sink immediately (barge-in abort).
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::tick_playback` (pub, L105)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::is_tts_playing` (pub, L113)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::note_playback` (private, L118)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::recent_pcm` (pub, L135)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `AudioPlayback::sample_rate` (pub, L140)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `overlay_collider` (pub(crate), L29)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `overlay_sphere` (private, L69)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `overlay_capsule` (private, L95)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `node_world` (private, L141)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `push_overlay_collider` (private, L150)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `collider_debug_lines` (pub(crate), L174)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `neutral_target` (pub, L15)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `compute_world_target` (pub, L19)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:
...
- [ ] `CompanionAvatar::load` (pub, L57)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::format_version_label` (pub, L95)
  - 役割: Human-readable VRM dialect label ("VRM 0.x" / "VRM 1.0") for status surfaces that show which format the loaded avatar uses.
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::load_motions` (pub, L99)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::motion_names` (pub, L119)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::current_motion` (pub, L124)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::select_motion_manually` (pub, L130)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::apply_body_motion` (pub, L135)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::motion_is_manually_overridden` (pub, L143)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::select_motion_named` (private, L147)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::reset_motion` (pub, L155)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::stop_motion` (pub, L176)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::cycle_motion` (pub, L183)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::reset_pose_and_springs` (private, L194)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::load_motion_at` (private, L211)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::apply_expression` (pub, L233)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::apply_expression_cue` (pub, L241)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::apply_expression_cue_weighted` (pub, L245)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::trigger_interaction_feedback` (pub, L258)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::apply_expression_weighted` (private, L278)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::tick_expression_cue` (pub, L288)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::clear_expression_cue` (pub, L311)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::apply_viseme` (pub, L320)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::set_look_at_target` (pub, L324)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::apply_body_event` (pub, L328)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::camera` (pub, L382)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::head_world` (pub, L387)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::tick` (pub, L395)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::tick_idle` (private, L432)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::sample_motion` (private, L457)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::eval_look_at` (private, L486)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::step_springs` (private, L506)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::overlay_model_transform` (private, L523)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::world_aabb` (pub, L543)
...
- [ ] `CompanionAvatar::overlay_bone_world` (pub, L556)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::part_world_aabb` (pub, L565)
  - 役割: Coarse CPU collider AABB for one body part. `None` when the bone is missing.
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::sphere_aabb` (private, L581)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::needs_redraw` (pub, L589)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::push_part_collider_wires` (pub(crate), L598)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `CompanionAvatar::fit_world_offset` (pub, L643)
...
- [ ] `push_interaction_outline` (pub(crate), L695)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `push_spring_collider_wires` (pub(crate), L722)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `debug_camera_uniform` (pub(crate), L735)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `render_to_texture` (pub, L739)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `write_default_minimal_vrm` (pub, L773)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `aabb_corners` (private, L779)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `project_ndc` (private, L792)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `clamp_ndc_translation` (private, L801)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `empty_frame` (private, L809)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `node_maps` (private, L825)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `discover_motions` (private, L845)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `ChromeKind::title` (pub, L24)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::restore` (pub, L46)
  - 役割: Restore visibility even when the WM rejects programmatic focus.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::restore_or_create` (pub, L56)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::raise` (pub, L73)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::create` (pub, L79)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::id` (pub, L141)
  - 役割: trivial getter
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::request_redraw` (pub, L145)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::sync_title` (pub, L149)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::owns_input` (pub, L154)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::composer_owns_keyboard` (pub, L159)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::place_caption` (pub, L163)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::on_window_event` (pub, L170)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::resize` (pub, L177)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: stale_surface_frame_is_skipped_during_resize
  - 結果:

- [ ] `ChromeWindow::layer` (pub, L186)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::take_actions` (pub, L190)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeWindow::paint` (pub, L197)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `minimum_inner_size` (pub, L246)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `surface_target_matches_window` (private, L257)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `clear_color` (pub, L265)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `place_caption_window` (private, L277)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `clamp_to_monitor` (private, L295)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `clamp_window_axis` (private, L331)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
...
- [ ] `EventFeeds::new_for_test` (pub(crate), L90)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `spawn_event_feeds` (pub, L102)
  - 役割: Spawn one socket per depth. Overlay/chat must only read `surface`.
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `spawn_depth` (private, L125)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `event_socket_loop` (private, L137)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `parse_surface_event` (private, L179)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `parse_detail_event` (private, L192)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `parse_live_event` (private, L196)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `string_field` (private, L348)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `f32_field` (private, L356)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `bool_field` (private, L363)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `PreparedSessionTarget::session_id` (pub(crate), L67)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::client` (pub, L88)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::adopt_new_session` (pub, L92)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: adopt_new_session_switches_before_history_refresh
  - 結果:

- [ ] `StageSession::soul_id` (pub, L133)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::session_id` (pub, L138)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::turn_id` (pub, L143)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::clear_turn` (pub, L152)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::history` (pub, L157)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: history_is_normalized_oldest_to_newest, adopt_new_session_switches_before_history_refresh
  - 結果:

- [ ] `StageSession::greetings` (pub, L162)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::replace_history` (pub, L166)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::occupants` (pub, L171)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::avatar_path` (pub, L176)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: pick_avatar_occupant_prefers_avatar_path
  - 結果:

- [ ] `StageSession::motions_dir` (pub, L181)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::clone_handle` (pub, L186)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::bootstrap` (pub, L197)
  - 役割: Resolve a soul (preferring an occupant with an avatar), open a session, load history.
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::retarget_soul` (pub, L215)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::commit_retarget` (pub(crate), L221)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::avatar_loads` (pub, L233)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::send_prompt` (pub, L250)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::send_steer` (pub, L254)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::send_follow_up` (pub, L258)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::send` (private, L262)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::barge_in` (pub, L282)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::cancel_turn` (pub, L286)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::claim_mic` (pub, L295)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::release_mic` (pub, L299)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::claim_speaker` (pub, L303)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::claim_notify` (pub, L307)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::refresh_history` (pub, L311)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::select_greeting` (pub, L317)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::respond_approval` (pub, L325)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::get_soul` (pub, L333)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::patch_soul_body` (pub, L337)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::claim` (private, L348)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `StageSession::release` (private, L359)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::refresh_history` (pub, L365)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::select_greeting` (pub, L371)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::send` (pub, L376)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::answer_job` (pub, L400)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::barge_in` (pub, L413)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::cancel_turn` (pub, L417)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::respond_approval` (pub, L426)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::claim_mic` (pub, L434)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::release_mic` (pub, L438)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::claim_speaker` (pub, L442)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::claim_notify` (pub, L446)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `SessionHandle::claim` (private, L450)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ensure_alicia` (pub, L463)
  - 役割: Import or activate Alicia so a stage occupant exposes `avatar_path`.
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ensure_avatar_occupants` (pub, L476)
  - 役割: Ensure up to `want` occupants expose a VRM `avatar_path`.
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `resolve_stage_with` (private, L485)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `import_named_companion` (private, L517)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `find_alicia_package` (private, L550)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `avatar_slots` (pub, L598)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: avatar_slots_caps_at_two_and_skips_text
  - 結果:

- [ ] `motions_dir_for_occupant` (pub, L608)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `occupant_with_avatar` (pub, L621)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `occupant_has_avatar` (pub, L629)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `occupant_label` (pub, L637)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `next_avatar_occupant` (pub, L648)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `pick_avatar_occupant` (pub, L671)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: pick_avatar_occupant_prefers_avatar_path
  - 結果:

- [ ] `resolve_stage` (private, L675)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: resolve_stage_surfaces_missing_bundle
  - 結果:

- [ ] `resolve_session_id` (private, L682)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `send_direct_interaction` (pub(crate), L700)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `prepare_soul_target` (pub(crate), L721)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `normalize_history` (pub, L745)
...
- [ ] `StageCore::detached` (pub, L23)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageCore::child` (pub, L31)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageCore::drop` (private, L37)
  - 役割: Drop
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `attach_or_spawn_core` (pub, L69)
...
- [ ] `caption_position_label` (pub(crate), L84)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `theme_label` (pub(crate), L95)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `language_value_label` (pub(crate), L105)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `core_lifetime_label` (pub(crate), L115)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `plugin_profile_label` (pub(crate), L124)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `log_kind_label` (pub(crate), L147)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `DetailTab::label` (pub, L172)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: detail_value_labels_do_not_expose_storage_ids
  - 結果:

- [ ] `DetailTab::keywords` (pub, L187)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `DetailTab::matches_search` (pub, L234)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `DetailTab::search_rank` (pub, L240)
  - 役割: Lower is a better match. `None` means the tab should be hidden.
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `best_search_tab` (private, L270)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for MemoryCandidateDraft::from` (private, L311)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: shared_scope_is_detected_from_original_or_edit, search_vo_switches_from_home_to_voice
  - 結果:

- [ ] `Trait for ScheduleBuilderState::default` (private, L493)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: default_provider_assets_skips_tool_plugins, local_timezone_name_never_panics_and_defaults_to_utc
  - 結果:

- [ ] `ScheduleBuilderState::spec_for` (pub, L531)
...
- [ ] `format_interval_spec` (private, L579)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `cron_spec` (private, L587)
...
- [ ] `DetailUiState::push_log` (pub, L631)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::invalidate_settings` (pub, L642)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::settings_load_failed` (pub, L646)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::settings_loaded` (pub(crate), L650)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::begin_settings_load` (pub(crate), L654)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::finish_settings_load` (pub(crate), L662)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::set_session_id` (pub(crate), L666)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::refresh_settings_on_open` (pub, L672)
...
- [ ] `DetailUiState::select_tab` (pub, L679)
  - 役割: Explicit navigation wins over the search box; otherwise search re-selects the tab every frame.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::next_activation_generation` (pub, L684)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::activation_is_current` (pub, L690)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::next_mcp_probe_generation` (pub, L694)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::mcp_probe_is_current` (pub, L700)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::invalidate_character` (pub, L704)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::invalidate_memory` (pub, L714)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `DetailUiState::sync_candidate_drafts` (pub(crate), L723)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `parse_core_fields` (pub, L750)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: parse_core_fields_reads_effective_tasks_and_profile
  - 結果:

- [ ] `nested_string` (private, L818)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `nested_bool` (private, L829)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `normalize_title_mode` (pub, L841)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `normalize_approval_mode` (pub, L850)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `mcp_args_text` (pub, L860)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `valid_mcp_id` (pub, L867)
...
- [ ] `set_mcp_args_text` (pub, L904)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `load_mcp_form` (pub, L912)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空
  - 既存テスト: なし
  - 結果:

- [ ] `validate_mcp_server` (pub, L920)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空
  - 既存テスト: なし
  - 結果:

- [ ] `validate_mcp_document` (pub, L943)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空
  - 既存テスト: なし
  - 結果:

- [ ] `mcp_credential_row` (pub, L953)
...
- [ ] `spawn_mcp_credential_save` (pub, L963)
...
- [ ] `is_provider_plugin_id` (pub, L1042)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `default_provider_assets_plugin` (pub, L1047)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `plugin_needs_key` (pub, L1059)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `plugin_is_local` (pub, L1064)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `plugin_has_fallback` (pub, L1071)
...
- [ ] `provider_bool` (private, L1078)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `provider_display_name` (pub, L1089)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `chat_provider_choices` (pub, L1109)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: chat_provider_choices_use_display_names_not_raw_ids
  - 結果:

- [ ] `provider_choices_for_seam` (pub, L1144)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `chat_setup_gap` (pub, L1177)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `chat_setup_status` (pub, L1191)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `chat_apply_block_reason` (pub, L1199)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `home_chat_next_step` (pub, L1216)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `SetupCard::title` (private, L1238)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `SetupCard::state_label` (private, L1242)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `SetupCard::detail` (private, L1250)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: detail_value_labels_do_not_expose_storage_ids, reopening_detail_refreshes_stale_vault_state
  - 結果:

- [ ] `home_status_cards` (pub(crate), L1272)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `setup_cards` (private, L1297)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `blocking_unconfigured` (pub, L1334)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `optional_unconfigured` (pub, L1343)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `list_models_status` (pub, L1352)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: list_models_status_prefers_error_then_empty_hint
  - 結果:

- [ ] `filtered_provider_models` (pub, L1364)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: filtered_provider_models_keeps_apply_reachable_by_narrowing
  - 結果:

- [ ] `sync_search_tab` (pub, L1377)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `onboarding_visible` (pub(crate), L1387)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `is_character_active` (pub, L1397)
...
- [ ] `companion_display_rows` (pub(crate), L1415)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: companion_display_rows_keep_overlay_order_and_chat_badges_separate
  - 結果:

- [ ] `companion_display_row` (private, L1455)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: companion_display_rows_keep_overlay_order_and_chat_badges_separate
  - 結果:

- [ ] `title_mode_label` (pub(crate), L1537)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `observation_scope_text` (pub(crate), L1545)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `memory_kind_label` (pub(crate), L1556)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `memory_scope_label` (pub(crate), L1568)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `editable_schema_fields` (pub, L1637)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `begin_plugin_config_load` (pub, L1649)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `plugin_config_is_loading` (pub, L1665)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `plugin_config_values_empty` (pub, L1670)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `plugin_config_values_valid` (pub, L1678)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `plugin_config_load_is_current` (pub, L1683)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `apply_plugin_config_view` (pub, L1692)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `plugin_config_request_is_current` (pub, L1703)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `plugin_config_status` (pub, L1707)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `request_overlay_monitor_action` (pub(crate), L1723)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `overlay_monitor_mode_label` (pub(crate), L1731)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `monitor_summary` (pub(crate), L1741)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `log_empty_copy` (pub(crate), L1759)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: log_empty_copy_is_resolved
  - 結果:

- [ ] `approval_mode_label` (pub(crate), L1763)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ensure_settings` (pub(crate), L1855)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `apply_ai_patch` (pub(crate), L1876)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `voice_settings_patch` (private, L1925)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `apply_voice_patch` (pub(crate), L1971)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `apply_observation_patch` (pub(crate), L1990)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `spawn_async` (private, L2019)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:
...
- [ ] `handle_select_tab` (pub, L35)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `handle_primary` (pub, L41)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `companion` (private, L88)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: companion_tab_applies_body_not_ai
  - 結果:

- [ ] `conversation` (private, L122)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
...
- [ ] `cursor_logical_to_world_2d` (pub, L235)
...
- [ ] `os_cjk_font_paths` (private, L34)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `first_available_cjk_font` (pub, L80)
...
- [ ] `GpuContext::create` (pub, L31)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `GpuContext::create_surface` (pub, L82)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `GpuContext::surface_format` (pub, L89)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `configure_surface` (pub, L100)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `acquire_frame` (pub, L123)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空
  - 既存テスト: なし
  - 結果:

- [ ] `backend_options` (private, L136)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `pick_alpha_mode` (pub, L154)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `alpha_mode_supports_transparency` (pub(crate), L178)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `create_depth` (pub, L186)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `format_has_alpha` (private, L209)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:
...
- [ ] `loader_lock` (private, L19)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `should_report_missing` (private, L30)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `select_language` (pub, L38)
...
- [ ] `Trait for RestoreLanguage::drop` (private, L93)
  - 役割: Drop
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `MoveResult::is_dragging` (pub, L32)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `GestureTracker::press` (pub, L76)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI / 空
  - 既存テスト: stationary_press_is_a_click, long_press_and_double_click_are_distinct, background_press_does_not_start_a_gesture
  - 結果:

- [ ] `GestureTracker::move_to` (pub, L103)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `GestureTracker::release` (pub, L123)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `GestureTracker::cancel` (pub, L164)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `GestureTracker::cancel_all` (pub, L177)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `Trait for StageInteractionController::default` (private, L65)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageInteractionController::mode` (pub, L77)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageInteractionController::ui_request` (pub, L82)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: clickable_ui_requests_interactive_entry
  - 結果:

- [ ] `StageInteractionController::cursor_hittest_enabled` (pub, L88)
  - 役割: Whether the native window should receive pointer events.
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `StageInteractionController::request_ui` (pub, L97)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageInteractionController::release_ui` (pub, L102)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageInteractionController::sync` (pub, L107)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageInteractionController::cancel` (pub, L112)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageInteractionController::apply_to_window` (pub, L137)
  - 役割: Apply the current mode to the window. Returns whether the OS call ran.
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `StageInteractionController::recompute` (private, L171)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `OverlayMonitorMode::from_setting` (pub, L23)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayMonitorMode::setting` (pub, L33)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `MonitorRect::right` (pub, L51)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `MonitorRect::bottom` (pub, L56)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `MonitorRect::contains` (pub, L61)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:
...
- [ ] `find_saved_monitor` (pub, L191)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `resolve_target` (pub, L219)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `saturating_i32` (private, L271)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `saturating_u32` (private, L281)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `OverlayWindow::create` (pub, L61)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::id` (pub, L111)
  - 役割: trivial getter
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::format` (pub, L116)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::set_slint_layer` (pub, L120)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::slint_layer` (pub, L124)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::slint_layer_mut` (pub, L128)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::has_avatars` (pub, L133)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::first_avatar` (pub, L138)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::first_avatar_mut` (pub, L142)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::avatar_mut` (pub, L146)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::avatar_or_first_mut` (pub, L153)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::reset_visemes` (pub, L161)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::resize` (pub, L168)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::set_click_through` (pub, L176)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::apply_click_through` (pub, L183)
...
- [ ] `OverlayWindow::toggle_chrome` (pub, L187)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::clear_avatars` (pub, L197)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::load_avatars` (pub, L201)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::set_interaction_targets` (pub, L251)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayWindow::tick_and_render` (pub, L262)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `load_one` (private, L314)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:
...
- [ ] `global_cursor_position` (pub, L51)
...
- [ ] `apply_click_through_windows` (private, L68)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `preferred_data_dir` (pub, L97)
  - 役割: Preferred persistent data directory for stage-local state.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayPlatform::attach` (pub, L125)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayPlatform::name` (pub, L137)
  - 役割: trivial getter
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayPlatform::apply` (pub, L142)
  - 役割: Map controller mode + scene geometry onto the OS hit-test path.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayPlatform::commit_region_push` (private, L195)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OverlayPlatform::should_push_region` (private, L201)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `PlatformKind::name` (private, L216)
  - 役割: trivial getter
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `detect_backend` (private, L231)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `rects_i32` (pub(crate), L258)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `physical_to_surface_local` (pub(crate), L268)
...
- [ ] `WaylandRegion::try_new` (pub, L37)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `WaylandRegion::apply` (pub, L90)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for AppData::event` (private, L128)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for AppData::event` (private, L149)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for AppData::event` (private, L161)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for AppData::event` (private, L173)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `X11Shape::try_new` (pub, L24)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `X11Shape::apply` (pub, L54)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `X11Shape::set_kind` (private, L79)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `PremulCompositor::new` (pub, L69)
  - 役割: コンストラクタ
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `PremulCompositor::target_format` (pub, L166)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `PremulCompositor::bind_ui_texture` (pub, L170)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `PremulCompositor::encode` (pub, L187)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `PremulCompositor::draw` (pub, L198)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `StageRenderer::new` (pub, L32)
  - 役割: コンストラクタ
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageRenderer::format` (pub, L54)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageRenderer::config` (pub, L59)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageRenderer::size` (pub, L64)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `StageRenderer::resize` (pub, L68)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `StageRenderer::reconfigure_surface` (pub, L82)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageRenderer::ensure_ui_target` (private, L91)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `StageRenderer::render` (pub, L123)
...
- [ ] `Trait for StageSlintPlatform::create_window_adapter` (private, L41)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageSlintPlatform::duration_since_start` (private, L53)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageSlintPlatform::set_clipboard_text` (private, L57)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageSlintPlatform::clipboard_text` (private, L61)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageWindowAdapter::try_new` (private, L74)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageWindowAdapter::take_redraw` (private, L88)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageWindowAdapter::window` (private, L95)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageWindowAdapter::size` (private, L99)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageWindowAdapter::renderer` (private, L103)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageWindowAdapter::set_visible` (private, L107)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for StageWindowAdapter::request_redraw` (private, L111)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `take_last_adapter` (private, L143)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `SlintOverlayLayer::new` (pub, L167)
  - 役割: コンストラクタ
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `SlintOverlayLayer::size` (pub, L180)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `SlintOverlayLayer::ensure_component` (pub, L184)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `SlintOverlayLayer::component` (pub, L209)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `SlintOverlayLayer::set_choices` (pub, L213)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `SlintOverlayLayer::take_actions` (pub, L227)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `SlintOverlayLayer::dispatch_winit` (pub, L231)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `SlintOverlayLayer::needs_redraw` (pub, L245)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `SlintOverlayLayer::render` (pub, L252)
  - 役割: Draw the current overlay UI into `target`.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::chat` (pub, L327)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::detail` (pub, L370)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::caption` (pub, L401)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::spotlight` (pub, L415)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::chat_ui` (pub, L440)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::detail_ui` (pub, L447)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::caption_ui` (pub, L454)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::spotlight_ui` (pub, L461)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::take_actions` (pub, L468)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::input_focused` (pub, L472)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::dispatch_winit` (pub, L480)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `ChromeLayer::render` (pub, L504)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `dispatch_to_window` (private, L538)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `convert_window_event` (private, L561)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `classify_ime` (private, L641)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `dispatch_ime` (private, L668)
...
- [ ] `is_modifier_key` (private, L690)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `forward_keyboard` (private, L704)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `modifier_key_events` (private, L708)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `key_text` (private, L732)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `set_owned_clipboard` (private, L773)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `read_owned_clipboard` (private, L791)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `with_owned_clipboard` (private, L802)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `set_selection_clipboard` (private, L814)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `set_selection_clipboard` (private, L825)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `read_selection_clipboard` (private, L828)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `read_selection_clipboard` (private, L838)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `PxRect::is_empty` (pub, L25)
  - 役割: trivial getter
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `PxRect::contains` (pub, L30)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `PxRect::padded` (pub, L38)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `PxRect::max_extent_delta` (pub, L48)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `VisualPrimitive::id` (pub, L77)
  - 役割: trivial getter
  - 視点: 正常系 / 空
  - 既存テスト: hidden_ui_drops_from_both_geometries
  - 結果:

- [ ] `VisualPrimitive::visual_rect` (pub, L85)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `InteractionPrimitive::id` (pub, L128)
  - 役割: trivial getter
  - 視点: 正常系 / 空
  - 既存テスト: hidden_ui_drops_from_both_geometries
  - 結果:

- [ ] `InteractionPrimitive::os_input_rect` (pub, L136)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `InteractionPrimitive::hit_rect` (pub, L148)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::set_anchors` (pub, L194)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::anchors` (pub, L202)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::new` (pub, L209)
  - 役割: コンストラクタ
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::set_visuals` (pub, L213)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::set_interactions` (pub, L220)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::hide` (pub, L227)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::show` (pub, L235)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::overlay_ui_flags` (pub, L244)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::is_dirty` (pub, L263)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::take_dirty` (pub, L268)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::is_hidden` (pub, L275)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::visual_geometry` (pub, L281)
  - 役割: Drawn footprint, including effect padding. Hidden ids are omitted.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `StageScene::interaction_geometry` (pub, L295)
...
- [ ] `StageScene::hit` (pub, L308)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: empty_geometry_hits_none
  - 結果:

- [ ] `InteractionGeometry::is_empty` (pub, L345)
  - 役割: trivial getter
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `InteractionGeometry::within_threshold` (pub, L351)
...
- [ ] `load_desktop_settings` (pub, L49)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `save_desktop_settings` (pub, L64)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `clamp_model_scale` (pub, L86)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `effective_model_scale` (pub, L95)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `default_position_for` (pub, L103)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `arranged_positions` (pub, L112)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: arranged_positions_keep_one_body_centered_and_two_separated
  - 結果:

- [ ] `seed_character_positions` (pub, L134)
...
- [ ] `mirror_active_position` (pub, L155)
...
- [ ] `normalize_displayed_souls` (pub(crate), L162)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ordered_visible_souls` (pub(crate), L189)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `HotkeyRegistration::initial` (private, L19)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: failed_initial_stays_inactive_until_a_late_retry_succeeds
  - 結果:

- [ ] `HotkeyRegistration::retry` (private, L26)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: failed_initial_stays_inactive_until_a_late_retry_succeeds
  - 結果:

- [ ] `HotkeyManager::new` (pub, L54)
  - 役割: Best-effort registration: skips hotkeys that are already taken.
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `HotkeyManager::retry_spotlight` (private, L71)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `HotkeyManager::poll` (pub, L81)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `HotkeyManager::spotlight_active` (pub, L96)
...
- [ ] `show_notification` (pub, L13)
  - 役割: Show a desktop notification with an optional hint category.
  - 視点: 正常系 / エラー / 空
  - 既存テスト: なし
  - 結果:

- [ ] `apply_category_hint` (private, L24)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `apply_category_hint` (private, L31)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `TrayManager::new` (pub, L35)
  - 役割: Build the tray icon and wire menu events into an internal channel.
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `TrayManager::try_recv` (pub, L98)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `TrayManager::take_interactions` (pub, L114)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `TrayManager::set_mic_active` (pub, L125)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `map_linux_event` (private, L139)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `map_menu_id` (private, L149)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `mic_menu_label` (private, L160)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: mic_menu_label_is_the_next_action
  - 結果:

- [ ] `load_icon_rgba` (private, L165)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `load_icon_bytes` (private, L177)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空
  - 既存テスト: なし
  - 結果:

- [ ] `synthetic_icon_rgba` (private, L185)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `WindowsTrayBackend::new` (pub(super), L213)
  - 役割: コンストラクタ
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `WindowsTrayBackend::try_recv` (pub(super), L235)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `WindowsTrayBackend::take_interactions` (pub(super), L239)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `WindowsTrayBackend::set_mic_active` (pub(super), L247)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `build_menu` (private, L253)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `build_icon` (private, L297)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `poll_tray_events` (private, L302)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `normalize_transcript` (pub(crate), L37)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `normalize_message` (private, L56)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `transcript_label` (pub(crate), L72)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `request_single_greeting_commit` (pub(crate), L84)
...
- [ ] `composer_send_allowed` (pub(crate), L144)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `chat_setup_cta_eligible` (pub(crate), L182)
...
- [ ] `Trait for SurfaceUiState::default` (private, L97)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `SurfaceUiState::push_action` (pub, L138)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `SurfaceUiState::close_chat` (pub, L147)
...
- [ ] `SurfaceUiState::chat_window_exists` (pub, L154)
  - 役割: Whether a chat window should currently be kept alive.
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `SurfaceUiState::begin_send` (pub(crate), L159)
  - 役割: A new turn supersedes the previous turn's composer feedback.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `SurfaceUiState::apply_text_delta` (pub(crate), L164)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `SurfaceUiState::on_turn_ended` (pub(crate), L179)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `SurfaceUiState::dismiss_caption` (pub(crate), L186)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `SurfaceUiState::caption_visible` (pub(crate), L192)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:
...
- [ ] `load_user_theme` (pub, L24)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `apply_to_global` (pub, L31)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `parse_color` (private, L49)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `Interpolation::from_gltf` (private, L75)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `T::keyframe_count` (pub, L105)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: sampler_keyframe_count
  - 結果:

- [ ] `Trait for VrmaPlayer::default` (private, L236)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: vrma_player_default_state
  - 結果:

- [ ] `VrmaPlayer::play` (pub, L248)
...
- [ ] `sample_scalar` (private, L298)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: sample_scalar_step, sample_scalar_linear
  - 結果:

- [ ] `sample_vec3` (private, L302)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: sample_vec3_linear
  - 結果:

- [ ] `sample_quat` (private, L306)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: sample_quat_linear_slerp, sample_quat_step
  - 結果:

- [ ] `sample_step` (private, L327)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `find_keyframe_index` (private, L345)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `sample_keyframes` (private, L360)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `sample_cubic_spline` (private, L395)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `sample_cubic_spline_quat` (private, L431)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `retarget_rotation` (pub, L474)
...
- [ ] `retarget_hips_translation` (pub, L496)
...
- [ ] `retarget_hips_to_dest` (private, L624)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `parse_vrma_properties` (private, L698)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `compute_node_rest_transforms` (private, L765)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `parse_animation` (private, L824)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `Trait for BeatSway::default` (private, L45)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: default_sway_is_inactive_and_leaves_frame_untouched
  - 結果:

- [ ] `BeatSway::on_pulse` (pub, L63)
...
- [ ] `BeatSway::is_active` (pub, L83)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `BeatSway::locomotion_speed_multiplier` (pub, L90)
...
- [ ] `Trait for OrthographicCamera::default` (private, L38)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `OrthographicCamera::set_aspect` (pub, L50)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `OrthographicCamera::look_at` (pub, L54)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:
...
- [ ] `compute_auto_fit_scale` (pub, L84)
...
- [ ] `Trait for ModelUniform::default` (private, L165)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ModelUniform::from_position_scale` (pub, L184)
...
- [ ] `DebugLine::vertices` (private, L79)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: debug_line_vertices_match_endpoints
  - 結果:

- [ ] `sphere_wireframe_lines_into` (pub, L96)
...
- [ ] `capsule_wireframe_lines_into` (pub, L161)
...
- [ ] `DebugRenderer::clear` (pub, L379)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `DebugRenderer::line_count` (pub, L383)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `DebugRenderer::push_line` (pub, L387)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `DebugRenderer::push_sphere_wireframe` (pub, L391)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `DebugRenderer::push_capsule_wireframe` (pub, L397)
...
- [ ] `Trait for PrimitiveMorphMeta::default` (private, L111)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: morph_meta_default_is_all_zeros
  - 結果:

- [ ] `ExpressionName::new` (pub, L163)
...
- [ ] `ExpressionName::as_str` (pub, L167)
  - 役割: trivial getter
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for ExpressionName::fmt` (private, L173)
  - 役割: Display/Debug
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for ExpressionName::from` (private, L179)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `PrimitiveMorphs::from_targets` (pub, L214)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ExpressionLayer::new` (pub, L263)
  - 役割: Build a fresh layer from per-primitive data. The model has zero expressions if `per_primitive` is empty.
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ExpressionLayer::expression_names` (pub, L285)
...
- [ ] `ExpressionLayer::set_expression` (pub, L297)
...
- [ ] `ExpressionLayer::apply_weights` (pub, L310)
...
- [ ] `ExpressionLayer::morphic_primitive_count` (pub, L324)
  - 役割: Number of primitives that have at least one morph target.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ExpressionLayer::apply_viseme_weights` (pub, L337)
...
- [ ] `ExpressionCompositor::load_card_expression` (pub, L38)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ExpressionCompositor::set_active_expression` (pub, L44)
  - 役割: Pass `None` to clear the selection.
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ExpressionCompositor::set_override` (pub, L50)
  - 役割: Overrides take precedence over the active card expression for the same blend-shape key.
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ExpressionCompositor::remove_override` (pub, L54)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ExpressionCompositor::clear_overrides` (pub, L58)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: clear_overrides_restores_base
  - 結果:

- [ ] `ExpressionCompositor::clear_card_expressions` (pub, L62)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ExpressionCompositor::compose` (pub, L69)
  - 役割: Override keys win over card keys. All weights are clamped to `[0, 1]`.
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: base_only_composes_card_weights
  - 結果:

- [ ] `ExpressionCompositor::active_expression_name` (pub, L87)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ExpressionCompositor::loaded_expression_names` (pub, L91)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
...
- [ ] `is_procedural` (pub, L66)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: is_procedural_recognises_all_targets
  - 結果:

- [ ] `ExpressionOverrideType::from_json_str` (pub, L90)
...
- [ ] `ExpressionDefinition::new` (pub, L139)
...
- [ ] `load_expression_overrides` (pub, L285)
...
- [ ] `ExpressionLayer::apply_overrides` (pub, L384)
...
- [ ] `def_none` (private, L454)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `is_binary_clamps_above_half_to_one` (private, L459)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: is_binary_clamps_above_half_to_one
  - 結果:

- [ ] `is_binary_clamps_below_half_to_zero` (private, L473)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: is_binary_clamps_below_half_to_zero
  - 結果:

- [ ] `is_binary_false_leaves_weight` (private, L487)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: is_binary_false_leaves_weight
  - 結果:

- [ ] `block_zeros_target_when_source_active` (private, L501)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: block_zeros_target_when_source_active
  - 結果:

- [ ] `block_does_not_affect_target_when_source_inactive` (private, L519)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: block_does_not_affect_target_when_source_inactive
  - 結果:

- [ ] `blend_attenuates_target_by_source_weight` (private, L536)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: blend_attenuates_target_by_source_weight
  - 結果:

- [ ] `blend_sums_multiple_sources` (private, L554)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: blend_sums_multiple_sources
  - 結果:

- [ ] `blend_clamped_to_zero_when_sum_ge_one` (private, L581)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: blend_clamped_to_zero_when_sum_ge_one
  - 結果:

- [ ] `block_wins_over_blend_when_both_affect_same_target` (private, L606)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: block_wins_over_blend_when_both_affect_same_target
  - 結果:

- [ ] `block_zeros_all_blink_family_members` (private, L636)
...
- [ ] `block_zeros_all_gaze_family_members` (private, L668)
...
- [ ] `same_kind_override_is_ignored` (private, L698)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: same_kind_override_is_ignored
  - 結果:

- [ ] `is_binary_source_uses_binary_output_for_override` (private, L712)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: is_binary_source_uses_binary_output_for_override
  - 結果:

- [ ] `is_binary_source_below_half_gives_no_override` (private, L731)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: is_binary_source_below_half_gives_no_override
  - 結果:

- [ ] `is_binary_target_suppressed_when_overridden` (private, L749)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: is_binary_target_suppressed_when_overridden
  - 結果:

- [ ] `is_binary_target_suppressed_by_is_binary_source` (private, L773)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: is_binary_target_suppressed_by_is_binary_source
  - 結果:

- [ ] `override_mouth_affects_only_mouth_targets` (private, L798)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: override_mouth_affects_only_mouth_targets
  - 結果:

- [ ] `override_look_at_affects_only_gaze_targets` (private, L827)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: override_look_at_affects_only_gaze_targets
  - 結果:

- [ ] `blink_override_affects_blink_left_and_right` (private, L856)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: blink_override_affects_blink_left_and_right
  - 結果:

- [ ] `empty_defs_is_no_op` (private, L882)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: empty_defs_is_no_op
  - 結果:

- [ ] `empty_weights_is_no_op` (private, L891)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: empty_weights_is_no_op
  - 結果:

- [ ] `custom_expression_can_override_procedural` (private, L905)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: custom_expression_can_override_procedural
  - 結果:

- [ ] `override_type_from_json_str_block` (private, L922)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: override_type_from_json_str_block
  - 結果:

- [ ] `override_type_from_json_str_blend` (private, L930)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: override_type_from_json_str_blend
  - 結果:

- [ ] `override_type_from_json_str_none` (private, L938)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: override_type_from_json_str_none
  - 結果:

- [ ] `override_type_from_json_str_unknown_falls_back_to_none` (private, L946)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: override_type_from_json_str_unknown_falls_back_to_none
  - 結果:

- [ ] `is_procedural_recognises_all_targets` (private, L954)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: is_procedural_recognises_all_targets
  - 結果:

- [ ] `gltf_from_vrmc` (private, L969)
...
- [ ] `load_expression_overrides_full_block` (private, L980)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: load_expression_overrides_full_block
  - 結果:

- [ ] `load_expression_overrides_missing_fields_default` (private, L1036)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: load_expression_overrides_missing_fields_default
  - 結果:

- [ ] `load_expression_overrides_missing_block_returns_empty` (private, L1059)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: load_expression_overrides_missing_block_returns_empty
  - 結果:

- [ ] `load_expression_overrides_unknown_override_string_falls_back` (private, L1068)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: load_expression_overrides_unknown_override_string_falls_back
  - 結果:

- [ ] `load_expression_overrides_is_binary_true_parsed` (private, L1089)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: load_expression_overrides_is_binary_true_parsed
  - 結果:

- [ ] `apply_overrides_on_direct_weight_map` (private, L1109)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: apply_overrides_on_direct_weight_map
  - 結果:
...
- [ ] `VrmBone::as_str` (pub, L140)
  - 役割: trivial getter
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for VrmBone::fmt` (private, L146)
  - 役割: Display/Debug
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for VrmBone::from` (private, L152)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: registry_built_from_canonicalize_then_insert
  - 結果:

- [ ] `Trait for VrmBone::from` (private, L158)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: registry_built_from_canonicalize_then_insert
  - 結果:

- [ ] `Trait for BoneRestTransform::default` (private, L184)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: bone_rest_transform_default_is_identity
  - 結果:

- [ ] `HumanoidBoneRegistry::new` (pub, L222)
  - 役割: Build an empty registry. Most code paths should use [`load_humanoid_bones`] instead.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `HumanoidBoneRegistry::insert` (pub, L231)
...
- [ ] `HumanoidBoneRegistry::lookup` (pub, L242)
...
- [ ] `HumanoidBoneRegistry::by_name` (pub, L249)
...
- [ ] `HumanoidBoneRegistry::head` (pub, L254)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `HumanoidBoneRegistry::hips` (pub, L260)
  - 役割: Convenience accessor for the `hips` bone (the root of the humanoid chain).
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `HumanoidBoneRegistry::chest` (pub, L267)
...
- [ ] `HumanoidBoneRegistry::jaw` (pub, L271)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `HumanoidBoneRegistry::left_eye` (pub, L275)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `HumanoidBoneRegistry::right_eye` (pub, L279)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `HumanoidBoneRegistry::iter` (pub, L284)
  - 役割: Iterate `(bone, entry)` in canonical (sorted) order.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `HumanoidBoneRegistry::names` (pub, L289)
  - 役割: Sorted list of registered canonical bone names.
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `HumanoidBoneRegistry::len` (pub, L293)
  - 役割: trivial getter
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `HumanoidBoneRegistry::is_empty` (pub, L297)
  - 役割: trivial getter
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `canonicalize_bone_name` (pub, L319)
...
- [ ] `MotionLayer::as_str` (pub, L50)
  - 役割: Stable display / log label.
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `LayerComposer::accept_motion` (pub, L102)
  - 役割: `priority` should follow the convention: 4 = llm, 3 = affect, 2 = hysteresis, 1 = fallback.
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `LayerComposer::cancel_motion` (pub, L128)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `LayerComposer::cancel_all_motions` (pub, L136)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `LayerComposer::set_expression` (pub(crate), L151)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `LayerComposer::remove_expression` (pub(crate), L180)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `LayerComposer::clear_expressions` (pub(crate), L188)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `LayerComposer::tick` (pub, L195)
...
- [ ] `LayerComposer::active_motion_names` (pub(crate), L225)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: active_motion_names_full_preempts
  - 結果:

- [ ] `LayerComposer::compose` (pub, L239)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `LayerComposer::has_active_motion` (pub(crate), L274)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `LayerComposer::place_slot` (private, L278)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:
...
- [ ] `detect_format_version` (private, L73)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `validate_format` (private, L91)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:
...
- [ ] `load_all_meshes` (private, L344)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `load_primitive_morph_targets` (private, L667)
...
- [ ] `load_merged_skeleton_and_remaps` (private, L738)
...
- [ ] `load_node_hierarchy` (private, L831)
...
- [ ] `load_primitive_base_color_texture` (private, L894)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `load_image_data` (private, L1015)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `normalize_morph_offset` (private, L1079)
...
- [ ] `load_mtoon_gpu_textures` (private, L1086)
...
- [ ] `Trait for LookAtRangeMap::default` (private, L82)
...
- [ ] `LookAtRangeMapSet::apply_horizontal` (pub, L155)
...
- [ ] `LookAtRangeMapSet::apply_vertical` (pub, L166)
...
- [ ] `Trait for LookAtProperties::default` (private, L210)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: default_properties_match_vrm_spec, load_look_at_partial_block_uses_spec_defaults
  - 結果:

- [ ] `LookAtEvaluator::new` (pub, L320)
...
- [ ] `LookAtEvaluator::evaluate` (pub, L348)
...
- [ ] `yaw_pitch_to_delta` (private, L483)
...
- [ ] `mesh_bin_chunk` (private, L32)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `pack_glb` (private, L73)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `VrmFormatVersion::as_label` (pub, L44)
  - 役割: Human-readable label used by GUI surfaces that show which dialect a loaded avatar uses.
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `AlphaMode::render_phase` (pub, L116)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `Skeleton::joint_count` (pub, L179)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `NodeHierarchy::len` (pub, L259)
  - 役割: trivial getter
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `NodeHierarchy::is_empty` (pub, L265)
  - 役割: `true` when no nodes were captured (the model file had zero glTF `Node` objects — malformed).
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `NodeHierarchy::compute_world_transforms` (pub, L274)
...
- [ ] `evaluate_vrma` (pub, L697)
  - 役割: Sample a VRMA clip with NLR retargeting onto this model's rest pose.
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `MeshVertex::as_bytes` (pub, L771)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for SkinMatrix::from` (private, L1553)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `OutlineWidthMode::from_json_str` (private, L49)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for MToonMaterial::default` (private, L137)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: defaults_when_extension_missing, defaults_when_extension_present_but_empty
  - 結果:

- [ ] `load_mtoon_materials` (pub, L182)
...
- [ ] `parse_vec3` (private, L333)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `parse_texture_ref` (private, L343)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `parse_texture_ref_from_obj` (private, L348)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for MToonGpuTextures::fmt` (private, L384)
  - 役割: Display/Debug
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `texture_flags` (pub, L391)
  - 役割: Used by the renderer to fill the per-material uniform.
  - 視点: 正常系 / true/false
  - 既存テスト: texture_flags_bitmask
  - 結果:

- [ ] `Trait for MToonUniform::default` (private, L448)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: defaults_when_extension_missing, defaults_when_extension_present_but_empty
  - 結果:

- [ ] `MToonUniform::from_material` (pub, L466)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
...
- [ ] `RollAxis::as_vec3` (private, L44)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: roll_axis_as_vec3, aim_axis_as_vec3
  - 結果:

- [ ] `RollAxis::from_json_str` (private, L52)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `AimAxis::as_vec3` (private, L75)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: roll_axis_as_vec3, aim_axis_as_vec3
  - 結果:

- [ ] `AimAxis::from_json_str` (private, L86)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `NodeConstraint::source_node` (pub, L133)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `NodeConstraint::weight` (pub, L141)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI
...
- [ ] `NodeConstraintRegistry::len` (pub, L170)
  - 役割: trivial getter
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `NodeConstraintRegistry::is_empty` (pub, L174)
  - 役割: trivial getter
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `NodeConstraintRegistry::evaluate` (pub, L202)
...
- [ ] `NodeConstraintRegistry::eval_rotation` (private, L265)
...
- [ ] `load_node_constraints` (pub, L324)
...
- [ ] `PostProcessor::intermediate_view` (pub, L310)
...
- [ ] `VrmRenderer::render_mask` (pub, L1021)
...
- [ ] `VrmRenderer::draw_primitive` (private, L1087)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `VrmRenderer::upload_morph_meta` (private, L1141)
...
- [ ] `VrmRenderer::update_skin_palette` (pub, L1190)
...
- [ ] `base_color_bind_group_layout` (private, L1276)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `build_dummy_base_color_gpu` (private, L1300)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `build_dummy_morph_gpu` (private, L1370)
...
- [ ] `parse_colliders` (private, L165)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `parse_collider_groups` (private, L204)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `parse_springs` (private, L229)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `parse_vec3` (private, L303)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `SpringBoneSimulator::new` (pub, L361)
...
- [ ] `SpringBoneSimulator::step` (pub, L483)
...
- [ ] `thumbnail_image_index` (private, L47)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:
...
- [ ] `VisemeAnalyzer::window_size` (pub, L133)
...
- [ ] `VisemeAnalyzer::push_pcm` (pub, L143)
...
- [ ] `VisemeAnalyzer::analyze` (pub, L156)
...
- [ ] `smoothstep` (private, L293)
  - 役割: Hermite smoothstep between `edge0` and `edge1`, clamped to `[0, 1]`.
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果:

- [ ] `smooth_weights` (private, L302)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `smooth_field` (private, L314)
...
- [ ] `AllowedUserName::parse` (private, L71)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `UsagePermission::parse` (private, L95)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `root_vrm` (private, L103)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `as_object` (private, L107)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `parse_vec3` (private, L111)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `vec3_field` (private, L119)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `parse_meta` (pub(crate), L126)
...
- [ ] `convert_humanoid` (pub(crate), L186)
...
- [ ] `convert_blendshapes` (pub(crate), L248)
...
- [ ] `convert_look_at` (pub(crate), L322)
...
- [ ] `parse_legacy_range` (private, L340)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `convert_spring_bones` (pub(crate), L356)
...
- [ ] `load_mtoon_materials_vrm0` (pub(crate), L482)
...
- [ ] `ApiClient::new` (pub, L40)
  - 役割: コンストラクタ
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::base` (pub, L54)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::client_id` (pub, L59)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::token` (pub, L64)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::request` (private, L68)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::send_json` (private, L75)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::send_empty` (private, L99)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::health` (pub, L104)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_souls` (pub, L109)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::get_soul` (pub, L114)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_greetings` (pub, L119)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::patch_soul_body` (pub, L124)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::patch_soul_skills` (pub, L132)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_sessions` (pub, L144)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::search_sessions` (pub, L151)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::create_session` (pub, L165)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::get_session` (pub, L173)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::patch_session` (pub, L178)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::fork_session` (pub, L190)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::split_session` (pub, L195)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::end_session` (pub, L200)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::barge_in` (pub, L212)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::listen` (pub, L217)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::listen_stream` (pub, L230)
  - 役割: Open a bulk mic PCM socket. Binary frames are [`PCM_S16LE`] at `sample_rate`.
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::stage` (pub, L249)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::soul_affect` (pub, L254)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::export_session` (pub, L259)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::send_message` (pub, L264)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::history` (pub, L282)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::select_greeting` (pub, L294)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::cancel_queued` (pub, L309)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::compact` (pub, L321)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::cancel_turn` (pub, L329)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_jobs` (pub, L334)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::create_job` (pub, L342)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::get_job` (pub, L347)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::cancel_job` (pub, L352)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::answer_job` (pub, L357)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::answer_question` (pub, L365)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_tasks` (pub, L381)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::create_task` (pub, L389)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::get_task` (pub, L394)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::cancel_task` (pub, L399)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::verify_task` (pub, L404)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::approve_task_scope` (pub, L409)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_schedules` (pub, L414)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::create_schedule` (pub, L419)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::patch_schedule` (pub, L427)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / true/false / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::delete_schedule` (pub, L435)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_artifacts` (pub, L440)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::artifact_content` (pub, L451)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_memories` (pub, L456)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::patch_memory` (pub, L468)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::delete_memory` (pub, L480)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_pending_memories` (pub, L485)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::resolve_memory_candidate` (pub, L496)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_memory_journal` (pub, L511)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_tools` (pub, L522)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::test_tool` (pub, L527)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_plugins` (pub, L535)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_provider_models` (pub, L540)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_provider_assets` (pub, L551)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::install_provider_asset` (pub, L562)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::provider_asset_install_status` (pub, L573)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::refresh_provider_assets_catalog` (pub, L584)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::set_active_provider_asset` (pub, L595)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::restart_plugin` (pub, L606)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::plugin_config` (pub, L611)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::validate_plugin_config` (pub, L616)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::plugin_config_options` (pub, L631)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::apply_plugin_config` (pub, L646)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::mcp` (pub, L658)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::put_mcp` (pub, L663)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::mcp_catalog` (pub, L668)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::probe_mcp` (pub, L673)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_approvals` (pub, L678)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::respond_approval` (pub, L683)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::list_characters` (pub, L691)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::import_character` (pub, L696)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::import_character_archive_b64` (pub, L704)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::export_character` (pub, L715)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::activate_character` (pub, L720)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::settings` (pub, L725)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::patch_settings` (pub, L730)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::settings_schema` (pub, L735)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::audit` (pub, L740)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::usage` (pub, L745)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::diag_spans` (pub, L753)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::backup` (pub, L758)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::restore` (pub, L763)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::exclusive` (pub, L768)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::claim_resource` (pub, L773)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::release_resource` (pub, L788)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::openapi` (pub, L803)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::events` (pub, L809)
  - 役割: Open a depth-filtered event socket. `depth` is `surface` or `detail`.
  - 視点: 正常系 / None / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ApiClient::connect_ws` (private, L825)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `EventSocket::recv_json` (pub, L877)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ListenStream::send_pcm` (pub, L908)
  - 役割: Send one mono `f32` frame packed as [`PCM_S16LE`].
  - 視点: 正常系 / エラー / 0 / 端 / HiDPI / 空 / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `ListenStream::recv` (pub, L916)
  - 役割: Drive ping/pong and observe a server close. `None` means the socket ended.
  - 視点: 正常系 / None / エラー / タイムアウト
  - 既存テスト: なし
  - 結果:

- [ ] `session_search_query` (private, L933)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `ApiError::error_class` (pub, L25)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ApiError::from_problem` (pub, L34)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `encode_pcm_s16le` (pub, L13)
  - 役割: Pack mono `f32` (`-1.0..=1.0`) as little-endian `i16`.
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果:

- [ ] `decode_pcm_s16le` (pub, L41)
...
- [ ] `default_tz` (private, L303)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `default_action` (private, L307)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `default_true` (private, L493)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `ResourceKind::as_str` (pub, L637)
  - 役割: trivial getter
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `ResourceKind::parse` (pub, L645)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `update_global_config` (pub, L23)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `get_global_config` (pub, L33)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `get_global_section` (pub, L51)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `registered_settings_section_keys` (pub, L84)
...
- [ ] `registered_schemas_for` (pub, L97)
...
- [ ] `register_config_schema` (pub, L118)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果:

- [ ] `register_runtime_schema` (pub, L136)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空
  - 既存テスト: なし
  - 結果:

- [ ] `runtime_rules_is_default` (private, L158)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for EneConfig::default` (private, L199)
  - 役割: Default
  - 視点: 正常系
...
- [ ] `EneConfig::get_section` (pub, L220)
...
- [ ] `EneConfig::set_section` (pub, L276)
...
- [ ] `EneConfig::set_section_value` (pub, L340)
...
- [ ] `EneConfig::section_value` (pub, L360)
...
- [ ] `EneConfig::remove_section` (pub, L368)
...
- [ ] `serialize_json_layer` (private, L644)
...
- [ ] `serialize_json_layer_with_env` (private, L650)
  - 役割: Variant of [`serialize_json_layer`] whose layered baseline uses an injected env layer instead of the process environment.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `snapshot_schema_registry` (private, L705)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `generate_schema_json` (pub, L716)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空
  - 既存テスト: なし
  - 結果:

- [ ] `load_config` (pub, L778)
...
- [ ] `load_config_from` (pub, L783)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `load_full_config` (pub, L787)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `migrate_settings_file` (private, L804)
...
- [ ] `load_full_config_from` (pub, L895)
...
- [ ] `extract_layered_config_with_env` (private, L905)
...
- [ ] `extract_layered_config` (private, L945)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `read_top_level_order` (private, L953)
...
- [ ] `write_schemas_inner` (private, L977)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `atomic_write` (pub, L1012)
...
- [ ] `preserve_permissions` (private, L1069)
...
- [ ] `restore_top_level_order` (private, L1123)
...
- [ ] `name::default` (private, L106)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `name::path` (private, L118)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `register` (private, L129)
  - 役割: # Safety Called by `ctor` before `main`. Only safe registration code is executed; no I/O, TLS, or cross-ctor ordering assumed.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `name::default` (private, L158)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `name::path` (private, L170)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `register` (private, L181)
  - 役割: # Safety Called by `ctor` before `main`. Only safe registration code is executed; no I/O, TLS, or cross-ctor ordering assumed.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `name::default` (private, L210)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `name::path` (private, L222)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `register` (private, L239)
  - 役割: # Safety Called by `ctor` before `main`. Only safe registration code is executed; no I/O, TLS, or cross-ctor ordering assumed.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `registry` (private, L93)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `current_version` (private, L102)
...
- [ ] `document_version` (pub(crate), L179)
...
- [ ] `set_version` (private, L183)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `apply_migrations` (pub, L214)
...
- [ ] `migrate_drop_legacy_plugin_list` (pub(crate), L263)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `migrate_clear_echo_bindings` (pub(crate), L291)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `register_config_migrations` (private, L326)
  - 役割: # Safety Called by `ctor` before `main`. Only safe registration code is executed; no I/O, TLS, or cross-ctor ordering assumed.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `resolve_data_dir` (private, L34)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None / 空
  - 既存テスト: resolve_data_dir_prefers_override_then_assets
  - 結果:

- [ ] `resolve_assets_dir_impl` (private, L41)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:
...
- [ ] `config_file_path` (pub, L73)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: config_file_path_is_under_data_dir
  - 結果:

- [ ] `pattern_pack_path_in` (pub(crate), L82)
...
- [ ] `pattern_pack_path` (pub, L86)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `schema_file_path` (pub, L90)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `character_schema_file_path` (pub, L94)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `character_card_schema_file_path` (pub, L100)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `builtin_tools_dir` (pub, L105)
  - 役割: Same directory as the executable (debug) or its `tools/` subdirectory (release)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `user_tools_dir` (pub, L120)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `tool_socket_dir` (pub, L124)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `builtin_plugins_dir` (pub, L129)
  - 役割: Same directory as the executable (debug) or its `plugins/` subdirectory (release).
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `user_plugins_dir` (pub, L144)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `plugin_socket_dir` (pub, L148)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `socket_dir_for` (private, L152)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `character_settings_path` (pub, L166)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `character_settings_path_in` (pub, L170)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `character_dir` (pub, L176)
  - 役割: Returns the directory containing the character card and runtime data (`assets_dir/characters/{name}/`).
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `character_dir_in` (pub, L180)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `compile_forget_patterns` (private, L112)
...
- [ ] `parse_embedded_patterns` (private, L176)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `PatternLibrary::load` (pub, L194)
...
- [ ] `PatternLibrary::load_from` (private, L221)
...
- [ ] `PatternLibrary::load_from_assets` (private, L245)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー / 空
  - 既存テスト: なし
  - 結果:

- [ ] `PatternLibrary::built_in` (pub, L268)
...
- [ ] `PatternLibrary::built_in_english` (pub, L275)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `PatternLibrary::built_in_japanese` (pub, L279)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `PatternLibrary::lang` (pub, L283)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: load_falls_back_to_english_for_unknown_language, load_normalizes_language_aliases
  - 結果:

- [ ] `PatternLibrary::forget_patterns` (pub, L287)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `PatternLibrary::compiled_forget_patterns` (pub, L293)
  - 役割: Forget-detection patterns with their regexes pre-compiled, in match order. Prefer this on hot paths; see [`Self::load`].
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `PatternLibrary::intent_keywords` (pub, L302)
...
- [ ] `resolve_language_alias` (pub, L13)
...
- [ ] `resolve_system_language` (pub, L45)
...
- [ ] `is_embedded_language` (pub(crate), L52)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `find_source_dir` (private, L67)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `copy_dir_all` (private, L94)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:
...
- [ ] `Trait for ConfigStore::fmt` (private, L24)
  - 役割: Display/Debug
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `ConfigStore::load` (pub, L40)
...
- [ ] `ConfigStore::from_config` (pub, L66)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ConfigStore::config` (pub, L73)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ConfigStore::with_config_mut` (pub, L77)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ConfigStore::set_config` (pub, L82)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ConfigStore::get_section` (pub, L87)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ConfigStore::set_section` (pub, L94)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `ConfigStore::flush_if_dirty` (pub, L110)
...
- [ ] `ConfigStore::flush` (pub, L121)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `ConfigStore::is_dirty` (pub, L127)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果:

- [ ] `ConfigStore::mark_dirty` (pub, L133)
...
- [ ] `Trait for UserPersona::default` (private, L20)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `UserPersona::render_lines` (pub, L36)
...
- [ ] `Trait for TrayService::id` (private, L66)
  - 役割: trivial getter
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for TrayService::tool_tip` (private, L70)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for TrayService::icon_pixmap` (private, L80)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `Trait for TrayService::menu` (private, L84)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: menu_slots_clone
  - 結果:

- [ ] `Trait for TrayService::activate` (private, L89)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `LinuxTrayHandle::spawn` (pub, L118)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `LinuxTrayHandle::try_recv` (pub, L146)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果:

- [ ] `LinuxTrayHandle::take_interactions` (pub, L151)
  - 役割: (本体を読んで記入)
  - 視点: 正常系
  - 既存テスト: なし
  - 結果:

- [ ] `LinuxTrayHandle::set_item_label` (pub, L159)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:

- [ ] `build_ksni_menu` (private, L184)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果:
...
- [ ] `kill_pid` (private, L211)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:

- [ ] `kill_pid` (private, L222)
  - 役割: (本体を読んで記入)
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果:
...
- [ ] `slint::include_modules!()` generated bindings (`crates/ene-stage-ui/src/lib.rs`)
