...
進捗: 1190 / 1308 checked (78 waiting GUI)
...
- [x] `OverlayFocus::transition` (private, L80)
  ...
  - 結果: overlay_focus_tracks_chat_and_detail_transitions passed
...
- [x] `OverlayFocus::on_focus_event` (private, L84)
  ...
  - 結果: spotlight_and_caption_focus_protect_the_overlay, ordered_chrome_handoff_never_drops_protection, overlay_focus_loses_protection_when_overlay_gains_focus, chrome_focus_loss_keeps_protection_until_grace_expires, focus_event_returns_changed_only_on_actual_transition passed
...
- [x] `OverlayFocus::set` (private, L124)
  ...
  - 結果: overlay_focus_set_is_idempotent_for_the_same_target passed
...
- [x] `OverlayFocus::mark_pending_loss` (private, L131)
  ...
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: mark_pending_loss_is_a_noop_without_a_target passed

- [x] `OverlayFocus::expire_pending_loss` (private, L143)
  - 役割: Drop protection once a pending focus loss outlives its grace period
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: chrome_focus_loss_keeps_protection_until_grace_expires, mark_pending_loss_is_a_noop_without_a_target passed
...
- [ ] `run` (pub, L203)
  ...
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果: GUI/GPU/OS — lavapipe smoke (event loop entry)

- [x] `StageApp::chrome_window_exists` (private, L458)
  - 役割: thin accessor / one-line wrapper
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: chrome_window_exists_is_false_without_chrome passed
...
- [x] `StageApp::global_cursor_to_physical` (private, L468)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (send_chat_paints_the_optimistic_user_row_immediately, repeated_text_gets_a_second_optimistic_row_without_a_success_duplicate, failed_send_keeps_the_optimistic_row_and_restores_the_draft…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `StageApp::request_active_soul` (private, L607)
  ...
  - 結果: request_active_soul_enqueues_a_load_soul_outcome passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `StageApp::send_chat` (private, L1713)
  ...
  - 結果: send_chat_paints_the_optimistic_user_row_immediately passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `StageApp::cancel_job` (private, L4026)
  ...
  - 結果: cancel_job_other_errors_stay_raw passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `chat_window_action` (private, L4299)
  ...
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: chat_paint_does_not_raise_an_existing_window passed
...
- [x] `auth_failure` (private, L4624)
  ...
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果: auth_failure_matches_http_and_cookie_messages passed

- [x] `provider_asset_load_status` (private, L4631)
  - 役割: read body; see 結果
  - 視点: 正常系 / 空
  - 既存テスト: provider_asset_load_status_reports_success_and_empty_results
  - 結果: provider_asset_load_status_reports_success_and_empty_results passed (cargo test -p ene-stage --lib (347 passed))

- [x] `window_level` (private, L4636)
  - 役割: read body; see 結果
  - 視点: 正常系 / true/false
  - 既存テスト: save_applies_window_level_for_transparent_and_opaque_overlays
  - 結果: save_applies_window_level_for_transparent_and_opaque_overlays passed

- [x] `overlay_window_level` (private, L4645)
  - 役割: read body; see 結果
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: focused_chrome_lowers_overlay_until_focus_returns passed

- [x] `window_focus_state` (private, L4654)
  - 役割: Cyan AABB is drag-only
  - 視点: 正常系 / None / true/false
  - 既存テスト: window_focus_state_ignores_non_focus_events
  - 結果: chrome_focus_state_includes_focus_loss, window_focus_state_ignores_non_focus_events passed
...
- [x] `should_repaint_after_event` (private, L4664)
  ...
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: composer_focus_forces_repaint_on_every_chat_event passed
...
- [x] `user_theme_file` (private, L4700)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: user_theme_file_is_under_the_data_dir passed

- [x] `spotlight_entry_id` (private, L4704)
  - 役割: Repaint when Slint marked the window dirty, or when a text field is focused so IME/paste is not deferred until the next pointer event
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: spotlight_entry_id_is_stable_for_known_actions passed

- [x] `format_log_text` (private, L4719)
  - 役割: read body; see 結果
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: empty_log_payload_is_labeled_instead_of_hidden passed

- [x] `disambiguated_occupant_label` (private, L4728)
  - 役割: read body; see 結果
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: disambiguated_occupant_label_suffixes_duplicates passed

- [x] `map_turn_err` (private, L4752)
  - 役割: read body; see 結果
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: map_turn_err_translates_known_classes passed

- [x] `project_world_to_px` (private, L4762)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: project_world_to_px_handles_behind_and_zero_viewport passed

- [x] `world_aabb_to_px` (private, L4786)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: world_aabb_to_px_has_minimum_extent passed

- [x] `position_changed` (private, L4828)
  - 役割: read body; see 結果
  - 視点: 正常系 / true/false / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: position_changed_uses_epsilon_and_rejects_nan passed
...
- [x] `create_denied_by_approval` (private, L4858)
  ...
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果: create_denied_by_approval_is_case_insensitive passed
...
- [x] `cancel_already_terminal` (private, L4876)
  ...
  - 結果: cancel_already_terminal_matches_core_conflict_class passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `mic_toggle_is_blocked_until_stt_is_configured` (private, L6309)
  ...
  - 結果: mic_toggle_is_blocked_until_stt_is_configured passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `MicCapture::new` (pub, L26)
  ...
  - 視点: 正常系 / None / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: missing_device_still_constructs_an_idle_capture passed
...
- [x] `Resampler::new` (pub, L26)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (resampler_downsamples_by_ratio, resampler_passthrough_at_target_rate, resampler_empty_input_is_noop…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `rms` (pub, L62)
  ...
  - 結果: rms_energy_computes_correctly passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `MicListen::new` (pub, L38)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (closed_sender_reconnects_and_next_batch_arrives, listen_done_reconnects_after_backoff_while_mic_claimed, stale_generation_does_not_drop_current_stream…) passed (cargo test -p ene-stage --lib (347 passed)); body read

- [x] `MicListen::generation` (pub, L43)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: stale_generation_does_not_drop_current_stream
  - 結果: stale_generation_does_not_drop_current_stream passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `MicListen::release` (pub, L54)
  ...
  - 結果: release_does_not_reconnect passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `AudioHub::new` (pub, L39)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (stop_clears_recent_playback_pcm) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `AudioHub::stop` (pub, L131)
  ...
  - 結果: stop_clears_recent_playback_pcm passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `AudioPlayback::new` (pub, L271)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: new_is_idle_with_a_positive_sample_rate passed
...
- [x] `AudioPlayback::play_pcm` (pub, L67)
  ...
  - 視点: 正常系 / エラー / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果: module tests (new_is_idle_with_a_positive_sample_rate) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `overlay_collider` (pub(crate), L29)
  ...
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: module tests (sphere_follows_node_offset, model_scale_applies_to_center_and_radius, rotated_node_moves_offset…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `neutral_target` (pub, L15)
  ...
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: neutral_target_is_in_front_of_the_head passed (cargo test -p ene-stage --lib (347 passed))

- [x] `compute_world_target` (pub, L19)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: module tests (neutral_target_is_in_front_of_the_head, strength_zero_stays_on_the_neutral_axis, strength_one_follows_the_cursor_and_zero_dt_does_not_smooth…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `CompanionAvatar::format_version_label` (pub, L95)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (unknown_expression_is_not_stored, look_at_is_dirty_only_when_the_target_moves, default_minimal_vrm_writes_parseable_glb…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `pack_bundled_alicia` (pub, L27)
  ...
  - 視点: 正常系 / エラー / 空
  - 既存テスト: なし
  - 結果: module tests (pack_alicia_from_missing_dir_errors, pack_zip_has_local_file_magic, pack_alicia_from_embeds_vrm_and_motions…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `pack_alicia_from` (pub, L37)
  ...
  - 結果: pack_alicia_from_missing_dir_errors, pack_alicia_from_embeds_vrm_and_motions passed (cargo test -p ene-stage --lib (347 passed))

- [x] `pack_named_from` (pub, L41)
  - 役割: read body; see 結果
  - 視点: 正常系 / エラー / 空
  - 既存テスト: pack_named_from_uses_requested_id
  - 結果: pack_named_from_uses_requested_id passed (cargo test -p ene-stage --lib (347 passed))

- [x] `pack_zip` (private, L132)
  - 役割: read body; see 結果
  - 視点: 正常系 / エラー / 空
  - 既存テスト: pack_zip_has_local_file_magic
  - 結果: pack_zip_has_local_file_magic passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `ChromeKind::title` (pub, L24)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: chrome_kind_titles_are_localized passed

- [x] `ChromeWindow::restore` (pub, L46)
  - 役割: Restore visibility even when the WM rejects programmatic focus.
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (chat_and_detail_floor_matches_default_bounds, caption_and_spotlight_floors_stay_positive_and_below_defaults, caption_and_spotlight_stay_transparent…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `ChromeWindow::resize` (pub, L177)
  ...
  - 結果: stale_surface_frame_is_skipped_during_resize passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `surface_target_matches_window` (private, L257)
  ...
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: stale_surface_frame_is_skipped_during_resize passed

- [x] `clear_color` (pub, L265)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: caption_and_spotlight_stay_transparent, opaque_chrome_clear_is_fully_opaque passed
...
- [x] `clamp_window_axis` (private, L331)
  ...
  - 結果: clamp_window_axis_keeps_the_full_window_on_screen passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `EventFeeds::new_for_test` (pub(crate), L90)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (parses_text_delta, parses_body_command_by_prefix, parses_approval_requested_alias…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `PreparedSessionTarget::session_id` (pub(crate), L67)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (history_is_normalized_oldest_to_newest, adopt_new_session_switches_before_history_refresh, pick_avatar_occupant_prefers_avatar_path…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `StageSession::adopt_new_session` (pub, L92)
  ...
  - 結果: adopt_new_session_switches_before_history_refresh passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `StageSession::history` (pub, L157)
  ...
  - 結果: history_is_normalized_oldest_to_newest, adopt_new_session_switches_before_history_refresh passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `StageSession::avatar_path` (pub, L176)
  ...
  - 結果: pick_avatar_occupant_prefers_avatar_path passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `avatar_slots` (pub, L598)
  ...
  - 結果: avatar_slots_caps_at_two_and_skips_text passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `resolve_stage` (private, L675)
  ...
  - 結果: resolve_stage_surfaces_missing_bundle passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `StageCore::detached` (pub, L23)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (pid_file_name_matches_ctl, stage_data_dir_honors_ene_data_dir, stage_data_dir_default_is_not_repo_assets) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `stage_data_dir` (pub, L91)
  ...
  - 結果: stage_data_dir_honors_ene_data_dir, stage_data_dir_default_is_not_repo_assets passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `caption_position_label` (pub(crate), L84)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (valid_mcp_id_mirrors_daemon_rule, mcp_id_suggestion_sanitizes_display_names, detail_value_labels_do_not_expose_storage_ids…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `DetailTab::label` (pub, L172)
  ...
  - 結果: detail_value_labels_do_not_expose_storage_ids passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `Trait for MemoryCandidateDraft::from` (private, L311)
  ...
  - 結果: shared_scope_is_detected_from_original_or_edit, search_vo_switches_from_home_to_voice passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `Trait for ScheduleBuilderState::default` (private, L493)
  ...
  - 結果: default_provider_assets_skips_tool_plugins, local_timezone_name_never_panics_and_defaults_to_utc passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `parse_core_fields` (pub, L750)
  ...
  - 結果: parse_core_fields_reads_effective_tasks_and_profile passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `valid_mcp_id` (pub, L867)
  ...
  - 結果: valid_mcp_id_mirrors_daemon_rule passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `mcp_id_suggestion` (pub, L879)
  ...
  - 結果: mcp_id_suggestion_sanitizes_display_names passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `mcp_credential_row` (pub, L953)
  ...
  - 結果: mcp_credential_rows_skip_probe_rows_and_extract_server_ids passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `chat_provider_choices` (pub, L1109)
  ...
  - 結果: chat_provider_choices_use_display_names_not_raw_ids passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `SetupCard::detail` (private, L1250)
  ...
  - 結果: detail_value_labels_do_not_expose_storage_ids, reopening_detail_refreshes_stale_vault_state passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `list_models_status` (pub, L1352)
  ...
  - 結果: list_models_status_prefers_error_then_empty_hint passed (cargo test -p ene-stage --lib (347 passed))

- [x] `filtered_provider_models` (pub, L1364)
  - 役割: read body; see 結果
  - 視点: 正常系 / 空
  - 既存テスト: filtered_provider_models_keeps_apply_reachable_by_narrowing
  - 結果: filtered_provider_models_keeps_apply_reachable_by_narrowing passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `companion_display_rows` (pub(crate), L1415)
  ...
  - 結果: companion_display_rows_keep_overlay_order_and_chat_badges_separate passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `log_empty_copy` (pub(crate), L1759)
  ...
  - 結果: log_empty_copy_is_resolved passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `project` (pub, L10)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (select_tab_maps_index, home_row_opens_tab, companion_row_toggles_display…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `project_tab` (pub, L34)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (work_tab_creates_a_job_instead_of_applying_ai, conversation_tab_applies_ai, companion_tab_applies_body_not_ai…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `companion` (private, L88)
  ...
  - 結果: companion_tab_applies_body_not_ai passed (cargo test -p ene-stage --lib (347 passed))

- [x] `conversation` (private, L122)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: conversation_tab_applies_ai
  - 結果: conversation_tab_applies_ai passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `memory` (private, L173)
  ...
  - 結果: memory_and_connections_do_not_share_apply passed (cargo test -p ene-stage --lib (347 passed))

- [x] `work` (private, L197)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: work_tab_creates_a_job_instead_of_applying_ai
  - 結果: work_tab_creates_a_job_instead_of_applying_ai passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `clamp_position` (pub, L17)
  ...
  - 結果: clamp_position_bounds_coordinates passed (cargo test -p ene-stage --lib (347 passed))

- [x] `clamp_axis` (private, L24)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: module tests (clamp_position_bounds_coordinates, normalized_world_roundtrip, allows_input_combination_table…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `BodyDrag::grab_offset` (pub, L70)
  ...
  - 結果: press_on_body_arms_with_grab_offset, dragging_keeps_grab_offset_between_moves passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `allows_input` (pub, L95)
  ...
  - 結果: allows_input_combination_table passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `hit_test` (pub, L257)
  ...
  - 結果: hit_test_center_of_single_body, hit_test_misses_outside_corner, hit_test_respects_viewport_aspect, hit_test_prefers_nearest_body_on_overlap, hit_test_prefers_nearest_center_at_equal_depth passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `cjk_font_candidates` (pub, L11)
  ...
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果: module tests (candidates_include_bundled_noto_sans_jp, windows_candidates_include_yu_gothic_and_meiryo) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `backend_options` (private, L136)
  ...
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果: windows_uses_a_visual_swapchain_for_transparency passed
...
- [x] `alpha_mode_supports_transparency` (pub(crate), L178)
  ...
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: per_pixel_alpha_modes_are_distinguished_from_opaque_modes passed
...
- [x] `format_has_alpha` (private, L209)
  ...
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: format_has_alpha_matches_rgba_family passed
...
- [x] `loader_lock` (private, L19)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (stage_ftl_catalogs_parse_without_errors, fl_resolves_app_title, en_and_ja_ftl_have_the_same_keys…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `fl` (pub, L54)
  ...
  - 結果: fl_resolves_app_title passed (cargo test -p ene-stage --lib (347 passed))

- [x] `format` (pub, L72)
  - 役割: Resolve a message with named placeholders, e.g. `{ $tab }` in the FTL source.
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: format_fills_named_placeholders_and_empty_args_are_safe passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `MoveResult::is_dragging` (pub, L32)
  ...
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: sub_threshold_move_is_not_a_drag_and_is_dragging_tracks_state passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `GestureTracker::press` (pub, L76)
  ...
  - 結果: stationary_press_is_a_click, long_press_and_double_click_are_distinct, background_press_does_not_start_a_gesture passed (cargo test -p ene-stage --lib (347 passed))

- [x] `GestureTracker::move_to` (pub, L103)
  - 役割: read body; see 結果
  - 視点: 正常系 / エラー / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: module tests (stationary_press_is_a_click, movement_past_threshold_is_a_drag, long_press_and_double_click_are_distinct…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `Trait for StageInteractionController::default` (private, L65)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: default_is_passive_and_release_ui_drops_focus passed (cargo test -p ene-stage --lib (347 passed))

- [x] `StageInteractionController::mode` (pub, L77)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (opaque_overlay_stays_interactive, preferred_click_through_starts_passive, clickable_ui_requests_interactive_entry…) passed (cargo test -p ene-stage --lib (347 passed)); body read

- [x] `StageInteractionController::ui_request` (pub, L82)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: clickable_ui_requests_interactive_entry
  - 結果: clickable_ui_requests_interactive_entry passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `OverlayMonitorMode::from_setting` (pub, L23)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (mode_parsing_defaults_to_primary, named_monitor_id_survives_resolution_changes, union_covers_negative_and_adjacent_monitor_coordinates…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `union` (pub, L71)
  ...
  - 結果: union_covers_negative_and_adjacent_monitor_coordinates passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `apply_overlay_hints` (pub, L27)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (rate_limit_skips_tiny_moves, mode_change_bypasses_rate_limit, skipped_small_steps_do_not_reset_rate_limit…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `vs_main` (private, L37)
  ...
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: module tests (composite_uses_premultiplied_blend, shader_source_is_wgsl) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `Trait for StageSlintPlatform::create_window_adapter` (private, L41)
  ...
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果: module tests (ime_preedit_blocks_enter, ime_commit_is_composition_not_keypress, ime_disabled_and_empty_preedit_clear_composing…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `PxRect::new` (pub, L20)
  ...
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: module tests (visual_only_effect_does_not_enter_interaction_geometry, hidden_ui_drops_from_both_geometries, display_only_ui_is_visual_but_not_os_input…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `PxRect::contains` (pub, L30)
  ...
  - 視点: 正常系 / true/false / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: pxrect_contains_inside_edge_outside_and_empty passed (cargo test -p ene-stage --lib (347 passed))

- [x] `PxRect::padded` (pub, L38)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: pxrect_padded_clamps_negative_padding_to_empty passed (cargo test -p ene-stage --lib (347 passed))

- [x] `PxRect::max_extent_delta` (pub, L48)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: pxrect_max_extent_delta_uses_the_largest_axis passed (cargo test -p ene-stage --lib (347 passed))

- [x] `VisualPrimitive::id` (pub, L77)
  - 役割: trivial getter
  - 視点: 正常系 / 空
  - 既存テスト: hidden_ui_drops_from_both_geometries
  - 結果: hidden_ui_drops_from_both_geometries passed (cargo test -p ene-stage --lib (347 passed))

- [x] `VisualPrimitive::visual_rect` (pub, L85)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: empty_visual_rects_are_dropped_from_geometry passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `StageScene::hide` (pub, L227)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: hide_is_idempotent_and_show_unknown_is_a_noop passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `StageScene::overlay_ui_flags` (pub, L244)
  ...
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: overlay_ui_flags_ignore_hidden_and_display_only passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `StageScene::interaction_geometry` (pub, L295)
  ...
  - 結果: visual_only_effect_does_not_enter_interaction_geometry passed (cargo test -p ene-stage --lib (347 passed))

- [x] `StageScene::hit` (pub, L308)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: empty_geometry_hits_none
  - 結果: empty_geometry_hits_none passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `InteractionGeometry::within_threshold` (pub, L351)
  ...
  - 視点: 正常系 / true/false / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: within_threshold_is_false_when_rect_counts_differ passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `load_desktop_settings` (pub, L49)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (default_settings_have_empty_positions, seeding_gives_active_legacy_and_others_default, seeding_keeps_existing_entries_untouched…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `arranged_positions` (pub, L112)
  ...
  - 結果: arranged_positions_keep_one_body_centered_and_two_separated passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `HotkeyRegistration::initial` (private, L19)
  ...
  - 結果: failed_initial_stays_inactive_until_a_late_retry_succeeds passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `HotkeyManager::new` (pub, L54)
  ...
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果: module tests (failed_initial_stays_inactive_until_a_late_retry_succeeds, active_state_never_attempts_another_registration) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `TrayManager::new` (pub, L35)
  ...
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果: module tests (menu_ids_map_to_shared_shell_commands, shared_icon_asset_decodes, synthetic_icon_is_valid…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `mic_menu_label` (private, L160)
  ...
  - 結果: mic_menu_label_is_the_next_action passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `outer_offset` (pub, L10)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (all_named_positions_are_handled, top_sits_near_the_monitor_top, bottom_is_the_default_and_unknown_fallback…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `speech_text` (pub, L38)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: speech_text_prefers_caption_and_hides_provider_errors passed
...
- [x] `normalize_transcript` (pub(crate), L37)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (unrelated_status_never_arms_or_renders_the_mic_voice_cta, chat_setup_cta_needs_a_gap_and_an_empty_transcript, transcript_normalization_keeps_surface_roles_and_streaming_state…) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `request_single_greeting_commit` (pub(crate), L84)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: single_greeting_commits_once_without_click passed

- [x] `composer_send_allowed` (pub(crate), L144)
  - 役割: read body; see 結果
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: send_requires_non_whitespace_draft passed
...
- [x] `chat_setup_cta_eligible` (pub(crate), L182)
  ...
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: chat_setup_cta_needs_a_gap_and_an_empty_transcript passed
...
- [x] `Trait for SurfaceUiState::default` (private, L97)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (a_new_send_clears_the_previous_turn_status, ending_a_turn_clears_progress_and_terminal_composer_feedback, provider_error_delta_goes_to_status_not_caption…) passed (cargo test -p ene-stage --lib (347 passed)); body read

- [x] `SurfaceUiState::push_action` (pub, L138)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: new_chat_actions_are_deduplicated_while_inflight passed
...
- [x] `SpotlightAction::dismisses_palette` (pub, L17)
  ...
  - 視点: 正常系 / true/false
  - 既存テスト: なし
  - 結果: module tests (every_quick_command_dismisses_the_palette, empty_query_returns_all_entries, query_filters_case_insensitively…) passed (cargo test -p ene-stage --lib (347 passed)); body read

- [x] `SpotlightEntry::command` (private, L40)
  - 役割: read body; see 結果
  - 視点: 正常系 / 空
  - 既存テスト: every_quick_command_dismisses_the_palette
  - 結果: every_quick_command_dismisses_the_palette passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `SpotlightEntry::rank` (private, L61)
  ...
  - 結果: rank_order_prefix_before_contains_before_keyword passed (cargo test -p ene-stage --lib (347 passed))
...
- [x] `load_user_theme` (pub, L24)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (invalid_toml_falls_back, hex_color_parses) passed (cargo test -p ene-stage --lib (347 passed)); body read
...
- [x] `Interpolation::from_gltf` (private, L75)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (vrma_player_default_state, player_advance_loop_wraps, player_advance_once_stops_at_end…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `T::duration` (pub, L101)
  ...
  - 結果: sampler_duration_from_last_timestamp, sampler_duration_empty_is_zero passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `T::keyframe_count` (pub, L105)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: sampler_keyframe_count
  - 結果: sampler_keyframe_count passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `Trait for VrmaPlayer::default` (private, L236)
  - 役割: Default
  - 視点: 正常系
  - 既存テスト: vrma_player_default_state
  - 結果: vrma_player_default_state passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `VrmaPlayer::play` (pub, L248)
  ...
  - 結果: vrma_player_default_state, player_advance_loop_wraps, player_advance_once_stops_at_end, player_stop_resets_time, player_seek_clamps_negative, player_speed_multiplier, player_paused_does_not_advance passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `VrmaPlayer::pause` (pub, L253)
  - 役割: Pause playback (preserves current time).
  - 視点: 正常系
  - 既存テスト: player_paused_does_not_advance
  - 結果: player_paused_does_not_advance passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `VrmaPlayer::stop` (pub, L258)
  ...
  - 結果: player_advance_once_stops_at_end, player_stop_resets_time passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `VrmaPlayer::seek` (pub, L264)
  - 役割: Seek to a specific time in seconds.
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: player_seek_clamps_negative
  - 結果: player_seek_clamps_negative passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `VrmaPlayer::advance` (pub, L272)
  ...
  - 結果: player_advance_loop_wraps, player_advance_once_stops_at_end, player_paused_does_not_advance passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `sample_scalar` (private, L298)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: sample_scalar_step, sample_scalar_linear
  - 結果: sample_scalar_step, sample_scalar_linear passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `sample_vec3` (private, L302)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: sample_vec3_linear
  - 結果: sample_vec3_linear passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `sample_quat` (private, L306)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: sample_quat_linear_slerp, sample_quat_step
  - 結果: sample_quat_linear_slerp, sample_quat_step passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `retarget_rotation` (pub, L474)
  ...
  - 結果: retarget_rotation_identity_is_identity passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `retarget_hips_translation` (pub, L496)
  ...
  - 結果: retarget_hips_translation_no_scale_when_equal_height, retarget_hips_translation_scales_by_height_ratio passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `quat_to_yaw_pitch` (pub, L521)
  ...
  - 結果: quat_to_yaw_pitch_identity passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `evaluate_clip` (pub, L532)
  ...
  - 結果: evaluate_clip_empty, evaluate_clip_samples_bone_rotation, evaluate_clip_clamps_expression_weight, evaluate_clip_look_at passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `evaluate_retargeted` (pub, L573)
  ...
  - 結果: evaluate_retargeted_hips_are_dest_local_not_world_additive, evaluate_retargeted_y_only_does_not_shift_x passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `Trait for BeatSway::default` (private, L45)
  ...
  - 結果: default_sway_is_inactive_and_leaves_frame_untouched passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `BeatSway::on_pulse` (pub, L63)
  ...
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: module tests (default_sway_is_inactive_and_leaves_frame_untouched, pulse_activates_sway_and_snaps_phase_to_beat, sway_fades_out_after_pulse_tail…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `Trait for OrthographicCamera::default` (private, L38)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (auto_fit_tall_box_at_1_5_aspect_picks_y_axis, auto_fit_wide_box_at_1_5_aspect_picks_x_axis, auto_fit_degenerate_aabb_returns_floor…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `pixel_to_ndc` (pub, L218)
  ...
  - 結果: pixel_to_ndc_centres_and_flips_y passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `ndc_to_view_pos` (pub, L224)
  - 役割: read body; see 結果
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: ndc_to_view_pos_scales_by_viewport_extents, ndc_to_view_pos_viewport_agrees_with_aspect
  - 結果: ndc_to_view_pos_scales_by_viewport_extents, ndc_to_view_pos_viewport_agrees_with_aspect passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `view_pos_to_world` (pub, L242)
  ...
  - 結果: view_pos_to_world_round_trips_through_view passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `DebugLine::vertices` (private, L79)
  ...
  - 結果: debug_line_vertices_match_endpoints passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `sphere_wireframe_lines_into` (pub, L96)
  ...
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果: module tests (sphere_wireframe_lines_lie_on_unit_sphere, sphere_wireframe_lines_translate_and_scale, cross_lines_produces_three_segments_one_per_axis…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `cross_lines` (pub, L217)
  ...
  - 結果: cross_lines_produces_three_segments_one_per_axis passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `Trait for PrimitiveMorphMeta::default` (private, L111)
  ...
  - 結果: morph_meta_default_is_all_zeros passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `ExpressionName::new` (pub, L163)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (expression_names_dedupes_across_primitives, set_expression_clamps_weight, set_expression_unknown_name_returns_false_and_is_not_stored…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `ExpressionLayer::expression_names` (pub, L285)
  ...
  - 結果: expression_names_dedupes_across_primitives passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `ExpressionLayer::set_expression` (pub, L297)
  ...
  - 結果: set_expression_clamps_weight, set_expression_unknown_name_returns_false_and_is_not_stored passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `ExpressionLayer::apply_weights` (pub, L310)
  ...
  - 結果: apply_weights_overwrites, apply_weights_drops_unknown_names passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `ExpressionLayer::apply_viseme_weights` (pub, L337)
  ...
  - 結果: apply_viseme_weights_maps_all_five_targets, apply_viseme_weights_clamps_and_drops_unknown passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `ExpressionCompositor::load_card_expression` (pub, L38)
  ...
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果: module tests (base_only_composes_card_weights, override_wins_over_base, override_without_base…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `ExpressionCompositor::clear_overrides` (pub, L58)
  ...
  - 結果: clear_overrides_restores_base passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `ExpressionCompositor::compose` (pub, L69)
  ...
  - 結果: base_only_composes_card_weights passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `ExpressionCompositor::loaded_expression_names` (pub, L91)
  ...
  - 結果: loaded_expression_names_returns_all passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `is_procedural` (pub, L66)
  ...
  - 結果: is_procedural_recognises_all_targets passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `ExpressionOverrideType::from_json_str` (pub, L90)
  ...
  - 結果: override_type_from_json_str_block, override_type_from_json_str_blend, override_type_from_json_str_none, override_type_from_json_str_unknown_falls_back_to_none passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `ExpressionDefinition::new` (pub, L139)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (is_binary_clamps_above_half_to_one, is_binary_clamps_below_half_to_zero, is_binary_false_leaves_weight…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `apply_overrides` (pub, L181)
  ...
  - 結果: apply_overrides_on_direct_weight_map passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `load_expression_overrides` (pub, L285)
  ...
  - 結果: load_expression_overrides_full_block, load_expression_overrides_missing_fields_default, load_expression_overrides_missing_block_returns_empty, load_expression_overrides_unknown_override_string_falls_back, load_expression_overrides_is_binary_true_parsed passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `def` (private, L435)
  ...
  - 結果: empty_defs_is_no_op, load_expression_overrides_missing_fields_default passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `is_binary_clamps_above_half_to_one` (private, L459)
  ...
  - 結果: is_binary_clamps_above_half_to_one passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `is_binary_clamps_below_half_to_zero` (private, L473)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: is_binary_clamps_below_half_to_zero
  - 結果: is_binary_clamps_below_half_to_zero passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `is_binary_false_leaves_weight` (private, L487)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: is_binary_false_leaves_weight
  - 結果: is_binary_false_leaves_weight passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `block_zeros_target_when_source_active` (private, L501)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: block_zeros_target_when_source_active
  - 結果: block_zeros_target_when_source_active passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `block_does_not_affect_target_when_source_inactive` (private, L519)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: block_does_not_affect_target_when_source_inactive
  - 結果: block_does_not_affect_target_when_source_inactive passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `blend_attenuates_target_by_source_weight` (private, L536)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: blend_attenuates_target_by_source_weight
  - 結果: blend_attenuates_target_by_source_weight passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `blend_sums_multiple_sources` (private, L554)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: blend_sums_multiple_sources
  - 結果: blend_sums_multiple_sources passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `blend_clamped_to_zero_when_sum_ge_one` (private, L581)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: blend_clamped_to_zero_when_sum_ge_one
  - 結果: blend_clamped_to_zero_when_sum_ge_one passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `block_wins_over_blend_when_both_affect_same_target` (private, L606)
  ...
  - 結果: block_wins_over_blend_when_both_affect_same_target passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `block_zeros_all_blink_family_members` (private, L636)
  ...
  - 結果: block_zeros_all_blink_family_members passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `override_type_from_json_str_unknown_falls_back_to_none` (private, L946)
  ...
  - 結果: override_type_from_json_str_unknown_falls_back_to_none passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `load_expression_overrides_full_block` (private, L980)
  ...
  - 結果: load_expression_overrides_full_block passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `load_expression_overrides_missing_fields_default` (private, L1036)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: load_expression_overrides_missing_fields_default
  - 結果: load_expression_overrides_missing_fields_default passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `load_expression_overrides_missing_block_returns_empty` (private, L1059)
  ...
  - 結果: load_expression_overrides_missing_block_returns_empty passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `load_expression_overrides_unknown_override_string_falls_back` (private, L1068)
  ...
  - 結果: load_expression_overrides_unknown_override_string_falls_back passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `load_expression_overrides_is_binary_true_parsed` (private, L1089)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: load_expression_overrides_is_binary_true_parsed
  - 結果: load_expression_overrides_is_binary_true_parsed passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `VrmBone::as_str` (pub, L140)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (bone_name_set_has_55_unique_entries, canonicalize_bone_name_handles_known_variants, canonicalize_bone_name_returns_none_for_typo…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `Trait for VrmBone::from` (private, L152)
  ...
  - 結果: registry_built_from_canonicalize_then_insert passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `Trait for BoneRestTransform::default` (private, L184)
  ...
  - 結果: bone_rest_transform_default_is_identity passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `HumanoidBoneRegistry::lookup` (pub, L242)
  ...
  - 結果: registry_lookup_by_canonical_name passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `canonicalize_bone_name` (pub, L319)
  ...
  - 結果: canonicalize_bone_name_handles_known_variants, canonicalize_bone_name_returns_none_for_typo passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `MotionLayer::as_str` (pub, L50)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (full_preempts_upper_and_lower, upper_and_lower_coexist, higher_priority_replaces_same_layer…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `LayerComposer::tick` (pub, L195)
  ...
  - 結果: tick_advances_playing_motions, full_tick_preempts_upper passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `LayerComposer::active_motion_names` (pub(crate), L225)
  - 役割: read body; see 結果
  - 視点: 正常系 / 空
  - 既存テスト: active_motion_names_full_preempts
  - 結果: active_motion_names_full_preempts passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `version` (pub, L133)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: crate_version_is_semver passed
...
- [x] `detect_format_version` (private, L73)
  ...
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果: module tests (morph_offset_is_passthrough_in_raw_space, morph_offset_scales_linearly, bind_matrices_are_inverse_of_inverse_bind…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `load_vrm` (pub, L139)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: shipped_alicia_vrm_parses_and_loads, minimal_glb_loads_with_wgpu passed
...
- [x] `Trait for LookAtRangeMap::default` (private, L82)
  ...
  - 結果: default_properties_match_vrm_spec, load_look_at_partial_block_uses_spec_defaults passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `LookAtRangeMap::apply` (pub, L104)
  ...
  - 視点: 正常系 / 0 / 端 / HiDPI
  - 既存テスト: なし
  - 結果: module tests (default_properties_match_vrm_spec, range_map_scales_clamped_input, calc_yaw_pitch_straight_ahead_is_zero…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `calc_yaw_pitch` (pub, L521)
  ...
  - 結果: calc_yaw_pitch_straight_ahead_is_zero, calc_yaw_pitch_target_to_model_left_gives_positive_yaw, calc_yaw_pitch_target_above_gives_negative_pitch passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `load_look_at` (pub, L584)
  ...
  - 結果: load_look_at_parses_full_block, load_look_at_returns_none_when_block_missing, load_look_at_partial_block_uses_spec_defaults, load_look_at_malformed_offset_falls_back, load_look_at_unknown_type_falls_back_to_bone passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `minimal_vrm_glb_bytes` (pub, L17)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (minimal_glb_parses_as_vrm, write_glb_round_trip, minimal_glb_loads_with_wgpu…) passed (cargo test -p ene-vrm --lib (199 passed)); body read

- [x] `write_glb` (pub, L22)
  - 役割: Write [`minimal_vrm_glb_bytes`] to `path`.
  - 視点: 正常系 / エラー
  - 既存テスト: write_glb_round_trip
  - 結果: write_glb_round_trip passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `VrmFormatVersion::as_label` (pub, L44)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (joints_field_is_u32, vertex_size_is_aligned_for_4_way_attribs, node_hierarchy_world_transforms_root_only…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `look_at` (pub, L435)
  ...
  - 結果: update_skin_palette_applies_look_at_bone_delta_to_head, update_skin_palette_look_at_composes_onto_vrma_for_head, update_skin_palette_look_at_idempotent_for_zero_delta_or_missing_bones, update_skin_palette_look_at_ignores_missing_humanoid_bones passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `update_skin_palette` (pub, L569)
  ...
  - 結果: update_skin_palette_empty_joints_returns_empty, update_skin_palette_empty_nodes_returns_empty, update_skin_palette_no_frame_changes_returns_rest_palette, update_skin_palette_applies_bone_rotation, update_skin_palette_hips_local_does_not_double_rest_height, update_skin_palette_hips_translation_cascades_to_descendants, update_skin_palette_ignores_unknown_bone_names, update_skin_palette_uses_identity_for_out_of_range_joint_node passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `OutlineWidthMode::from_json_str` (private, L49)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (defaults_when_extension_missing, defaults_when_extension_present_but_empty, parse_full_material…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `Trait for MToonMaterial::default` (private, L137)
  ...
  - 結果: defaults_when_extension_missing, defaults_when_extension_present_but_empty passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `parse_vec3` (private, L333)
  ...
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果: parse_vec3_pads_and_ignores_non_numbers passed
...
- [x] `texture_flags` (pub, L391)
  ...
  - 結果: texture_flags_bitmask passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `MToonUniform::from_material` (pub, L466)
  ...
  - 結果: uniform_from_material_roundtrip passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `RollAxis::as_vec3` (private, L44)
  ...
  - 結果: roll_axis_as_vec3, aim_axis_as_vec3 passed (cargo test -p ene-vrm --lib (199 passed))

- [x] `RollAxis::from_json_str` (private, L52)
  - 役割: read body; see 結果
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果: module tests (parse_rotation_constraint, parse_roll_constraint, parse_aim_constraint…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `NodeConstraint::weight` (pub, L141)
  ...
  - 結果: parse_default_weight, eval_rotation_full_weight_copies_delta, eval_rotation_zero_weight_keeps_rest, constraint_source_and_weight_accessors passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `NodeConstraintRegistry::eval_rotation` (private, L265)
  ...
  - 結果: eval_rotation_identity_when_source_at_rest, eval_rotation_full_weight_copies_delta, eval_rotation_zero_weight_keeps_rest passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `NodeConstraintRegistry::eval_aim` (private, L293)
  ...
  - 結果: eval_aim_source_at_destination_returns_rest passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `load_spring_bones` (pub, L143)
  ...
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果: module tests (parse_empty_spring_bones, parse_sphere_collider, parse_capsule_collider…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `SpringBoneSimulator::step` (pub, L483)
  ...
  - 結果: simulator_step_no_forces_stays_at_rest, simulator_step_updates_state passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `load_vrm_thumbnail` (pub, L12)
  ...
  - 視点: 正常系 / None / エラー / 空
  - 既存テスト: なし
  - 結果: module tests (vrm_without_thumbnail_returns_none, embedded_thumbnail_bytes_are_returned) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `VisemeAnalyzer::new` (pub, L107)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (empty_buffer_yields_zero_weights, silence_yields_zero_weights, loud_signal_yields_nonzero_weights…) passed (cargo test -p ene-vrm --lib (199 passed)); body read
...
- [x] `VisemeAnalyzer::window_size` (pub, L133)
  ...
  - 結果: window_size_is_power_of_two_and_at_least_minimum passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `VisemeAnalyzer::reset` (pub, L192)
  ...
  - 結果: reset_clears_buffer_and_weights passed (cargo test -p ene-vrm --lib (199 passed))
...
- [x] `AllowedUserName::parse` (private, L71)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: allowed_user_name_parses_only_author passed

- [x] `UsagePermission::parse` (private, L95)
  - 役割: read body; see 結果
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: usage_permission_denies_only_disallow passed

- [x] `root_vrm` (private, L103)
  - 役割: read body; see 結果
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果: module tests (allowed_user_name_parses_only_author, usage_permission_denies_only_disallow, parse_vec3_pads_and_ignores_non_numbers…) passed (cargo test -p ene-vrm --lib (199 passed)); body read

- [x] `as_object` (private, L107)
  - 役割: read body; see 結果
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果: as_object_and_vec3_field_round_trip passed
...
- [x] `ApiClient::new` (pub, L40)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: new_strips_trailing_slash_and_stores_identity passed
...
- [x] `ApiClient::request` (private, L68)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: health_sends_bearer_and_client_id passed

- [x] `ApiClient::send_json` (private, L75)
  - 役割: read body; see 結果
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果: send_json_maps_401_problem_and_codec_errors passed

- [x] `ApiClient::send_empty` (private, L99)
  - 役割: HTTP GET `/api/v1/souls/{id}` via send_json/send_empty
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果: send_empty_accepts_empty_object passed
...
- [x] `ApiClient::list_souls` (pub, L109)
  ...
  - 視点: 正常系 / エラー / タイムアウト
  - 既存テスト: なし
  - 結果: one-line HTTP wrapper; request()/send_json/send_empty covered by health_sends_bearer_and_client_id, send_json_maps_401_problem_and_codec_errors, send_empty_accepts_empty_object, transport_error_when_nothing_listens; path/method read from source
...
- [x] `ApiClient::patch_soul_body` (pub, L124)
  ...
  - 視点: 正常系 / エラー / 空 / タイムアウト
  - 既存テスト: なし
  - 結果: module tests (new_strips_trailing_slash_and_stores_identity, session_search_query_encodes_optional_pairs, health_sends_bearer_and_client_id…) passed (cargo test -p ene-api --lib); body read
...
- [x] `ApiClient::listen` (pub, L217)
  ...
  - 視点: 正常系 / 空 / タイムアウト
  - 既存テスト: なし
  - 結果: transport_error_when_nothing_listens passed (cargo test -p ene-api --lib)
...
- [x] `session_search_query` (private, L933)
  ...
  - 視点: 正常系 / None / 空
  - 既存テスト: なし
  - 結果: session_search_query_encodes_optional_pairs passed (cargo test -p ene-api --lib)
...
- [x] `ApiError::error_class` (pub, L25)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: error_class_matches_variant passed (cargo test -p ene-api --lib)

- [x] `ApiError::from_problem` (pub, L34)
  - 役割: read body; see 結果
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (error_class_matches_variant) passed (cargo test -p ene-api --lib); body read
...
- [x] `openapi_json` (pub, L43)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (openapi_document_is_non_empty_json_object) passed (cargo test -p ene-api --lib); body read
...
- [x] `encode_pcm_s16le` (pub, L13)
  ...
  - 視点: 正常系 / 0 / 端 / HiDPI / 空
  - 既存テスト: なし
  - 結果: module tests (roundtrip_preserves_silence_and_peak, odd_length_is_codec_error, empty_pcm_roundtrips_to_empty_bytes) passed (cargo test -p ene-api --lib); body read
...
- [x] `QuestionEventKind::as_str` (pub, L21)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (round_trips_asked_event_with_ids, parses_resolved_event_without_optional_fields, parse_rejects_unknown_and_missing_fields) passed (cargo test -p ene-api --lib); body read

- [x] `QuestionEventKind::parse` (private, L28)
  - 役割: read body; see 結果
  - 視点: 正常系 / None / 空
  - 既存テスト: parses_resolved_event_without_optional_fields
  - 結果: parses_resolved_event_without_optional_fields passed (cargo test -p ene-api --lib)
...
- [x] `Problem::new` (pub, L19)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: problem_new_uses_about_blank passed (cargo test -p ene-api --lib)

- [x] `T::of` (pub, L41)
  - 役割: read body; see 結果
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: page_of_has_no_cursor passed (cargo test -p ene-api --lib)

- [x] `default_tz` (private, L303)
  - 役割: read body; see 結果
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (page_of_has_no_cursor, problem_new_uses_about_blank, occupant_display_name_defaults_when_omitted) passed (cargo test -p ene-api --lib); body read
...
- [x] `update_global_config` (pub, L23)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (env_uppercase_folds_to_lowercase_path, env_lowercase_works, malformed_settings_json_returns_error_not_default…) passed (cargo test -p ene-config --lib (63 passed)); body read
...
- [x] `path` (private, L48)
  ...
  - 結果: env_uppercase_folds_to_lowercase_path, set_path_writes_dotted_json_value, set_schema_via_set_path_round_trips passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `Trait for EneConfig::default` (private, L199)
  ...
  - 結果: malformed_settings_json_returns_error_not_default, empty_settings_json_extracts_defaults, defaults_not_forced_to_disk_on_save passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `EneConfig::set_section` (pub, L276)
  ...
  - 結果: set_section_preserves_unknown_subkeys, set_section_identical_write_is_noop, set_section_writes_clean_floats_into_extra passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `EneConfig::set_path` (pub, L308)
  ...
  - 結果: set_path_writes_dotted_json_value, set_schema_via_set_path_round_trips passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `section_to_value` (pub, L410)
  ...
  - 結果: section_to_value_f32_shortest_representation, section_to_value_f32_round_trips_exactly passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `set_nested` (pub, L471)
  ...
  - 結果: set_nested_through_non_object_leaf_errors passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `three_way_merge` (private, L578)
  ...
  - 結果: three_way_merge_keeps_raw_for_unchanged_and_drops_cleared, three_way_merge_recurses_into_nested_objects passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `atomic_write` (pub, L1012)
  ...
  - 結果: atomic_write_produces_final_contents_and_no_tmp_leftover, atomic_write_overwrites_existing_file, atomic_write_preserves_existing_permissions passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `name::default` (private, L106)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: define_config! expansion; cargo test -p ene-config --lib (config::tests) passed
...
- [x] `registry` (private, L93)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (current_version_is_untouched, missing_version_defaults_to_one, newer_version_errors…) passed (cargo test -p ene-config --lib (63 passed)); body read
...
- [x] `current_version` (private, L102)
  ...
  - 結果: current_version_is_untouched passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `app_data_dir` (pub, L17)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (config_file_path_is_under_data_dir, user_plugin_and_tool_dirs_are_under_data_dir, resolve_data_dir_prefers_override_then_assets…) passed (cargo test -p ene-config --lib (63 passed)); body read
...
- [x] `data_dir` (pub, L30)
  ...
  - 結果: config_file_path_is_under_data_dir, user_plugin_and_tool_dirs_are_under_data_dir, resolve_data_dir_prefers_override_then_assets passed (cargo test -p ene-config --lib (63 passed))

- [x] `resolve_data_dir` (private, L34)
  - 役割: read body; see 結果
  - 視点: 正常系 / None / 空
  - 既存テスト: resolve_data_dir_prefers_override_then_assets
  - 結果: resolve_data_dir_prefers_override_then_assets passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `config_file_path` (pub, L73)
  ...
  - 結果: config_file_path_is_under_data_dir passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `compile_forget_patterns` (private, L112)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (embedded_packs_parse_and_are_complete, shipped_pack_files_parse, load_prefers_runtime_asset_over_embedded…) passed (cargo test -p ene-config --lib (63 passed)); body read
...
- [x] `PatternLibrary::load` (pub, L194)
  ...
  - 結果: load_prefers_runtime_asset_over_embedded, load_falls_back_to_embedded_when_asset_missing, load_falls_back_to_english_for_unknown_language, load_normalizes_language_aliases passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `PatternLibrary::lang` (pub, L283)
  ...
  - 結果: load_falls_back_to_english_for_unknown_language, load_normalizes_language_aliases passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `resolve_language_alias` (pub, L13)
  ...
  - 結果: resolve_language_alias_rejects_non_ascii_alphabetic passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `system_language` (pub, L34)
  ...
  - 結果: resolve_system_language_selects_ja_only_for_japanese_locale passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `is_embedded_language` (pub(crate), L52)
  ...
  - 視点: 正常系 / true/false / 空
  - 既存テスト: なし
  - 結果: module tests (resolve_language_alias_rejects_non_ascii_alphabetic, resolve_system_language_selects_ja_only_for_japanese_locale) passed (cargo test -p ene-config --lib (63 passed)); body read
...
- [x] `ensure_resource_dirs` (pub, L10)
  ...
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果: module tests (debug_ensure_returns_assets_dir) passed (cargo test -p ene-config --lib (63 passed)); body read

- [x] `find_source_dir` (private, L67)
  - 役割: read body; see 結果
  - 視点: 正常系 / None
  - 既存テスト: なし
  - 結果: release-only deploy helper; debug ensure_resource_dirs uses source assets (debug_ensure_returns_assets_dir) passed
...
- [x] `Trait for ConfigStore::fmt` (private, L24)
  ...
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果: from_config_starts_clean_and_noop_flush passed
...
- [x] `ConfigStore::load` (pub, L40)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (from_config_starts_clean_and_noop_flush, with_config_mut_and_set_config_mark_dirty) passed (cargo test -p ene-config --lib (63 passed)); body read
...
- [x] `ConfigStore::config` (pub, L73)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: with_config_mut_and_set_config_mark_dirty passed
...
- [x] `ConfigStore::flush` (pub, L121)
  ...
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果: from_config_starts_clean_and_noop_flush passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `Trait for UserPersona::default` (private, L20)
  ...
  - 視点: 正常系
  - 既存テスト: なし
  - 結果: module tests (render_lines_omits_empty_optional_fields, render_lines_applies_prefix_consistently) passed (cargo test -p ene-config --lib (63 passed)); body read
...
- [x] `UserPersona::render_lines` (pub, L36)
  ...
  - 結果: render_lines_omits_empty_optional_fields, render_lines_applies_prefix_consistently passed (cargo test -p ene-config --lib (63 passed))
...
- [x] `rgba_to_icon` (pub(crate), L3)
  ...
  - 結果: rgba_to_icon_rotates_pixels passed (cargo test -p ene-tray-linux --lib (2 passed))
...
- [x] `Trait for TrayService::id` (private, L66)
  ...
  - 視点: 正常系 / 空
  - 既存テスト: なし
  - 結果: module tests (menu_slots_clone) passed (cargo test -p ene-tray-linux --lib (2 passed)); body read
...
- [x] `Trait for TrayService::menu` (private, L84)
  ...
  - 結果: menu_slots_clone passed (cargo test -p ene-tray-linux --lib (2 passed))
...
- [x] `pid_file_path` (pub, L42)
  ...
  - 結果: pid_file_path_is_under_data_dir passed (cargo test -p ene-ctl --lib (core.rs unit tests))

- [x] `binary_in_dir` (pub, L47)
  - 役割: read body; see 結果
  - 視点: 正常系 / None
  - 既存テスト: binary_in_dir_finds_sibling
  - 結果: binary_in_dir_finds_sibling passed (cargo test -p ene-ctl --lib (core.rs unit tests))

- [x] `find_ene_core_binary` (pub, L52)
  - 役割: read body; see 結果
  - 視点: 正常系 / エラー
  - 既存テスト: なし
  - 結果: module tests (parse_api_json_reads_url_and_token_file, read_api_ready_loads_token_from_sibling_file, read_api_ready_rejects_empty_url…) passed (cargo test -p ene-ctl --lib (core.rs unit tests)); body read

- [x] `parse_api_json` (pub, L74)
  - 役割: read body; see 結果
  - 視点: 正常系 / エラー / 空
  - 既存テスト: parse_api_json_reads_url_and_token_file
  - 結果: parse_api_json_reads_url_and_token_file passed (cargo test -p ene-ctl --lib (core.rs unit tests))

- [x] `read_api_ready` (pub, L78)
  - 役割: read body; see 結果
  - 視点: 正常系 / エラー
  - 既存テスト: read_api_ready_loads_token_from_sibling_file, read_api_ready_rejects_empty_url
  - 結果: read_api_ready_loads_token_from_sibling_file, read_api_ready_rejects_empty_url passed (cargo test -p ene-ctl --lib (core.rs unit tests))
...
- [ ] `slint::include_modules!()` generated bindings (`crates/ene-stage-ui/src/lib.rs`)
  ...
  - 既存テスト: なし（隔離クレート）
  - 結果: generated bindings; host properties exercised via ene-stage chrome/overlay tests and GUI smoke
